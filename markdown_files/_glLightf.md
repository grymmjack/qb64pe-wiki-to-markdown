...
<head>
<title>_glLightf - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlLightf rootpage-GlLightf skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glLightf</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glLightf</b> statement returns light source parameter values.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glLightf</a> GLenum <i>light</i>, GLenum <i>pname</i>, GLfloat <i>param</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gllightf" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   30.442      1 -total
 30.14%    9.174      1 Template:OpenGLTypesPlugin
 12.09%    3.679      1 Template:PageDescription
 11.91%    3.627      3 Template:Parameter
 11.56%    3.518      1 Template:PageSeeAlso
 11.29%    3.437      1 Template:PageParameters
  9.84%    2.997      1 Template:PageSyntax
  8.90%    2.708      1 Template:PageNavigation
  8.60%    2.617      1 Template:FixedStart
  8.47%    2.578      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:973-0!canonical and timestamp 20240714213340 and revision id 6927.
 -->
</div>
</div>
</div>
