...
<head>
<title>_glStencilOp - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlStencilOp rootpage-GlStencilOp skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glStencilOp</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glStencilOp</b> statement sets the stencil test actions.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glStencilOp</a> GLenum <i>fail</i>, GLenum <i>zfail</i>, GLenum <i>zpass</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glstencilop" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   19.393      1 -total
 29.14%    5.651      1 Template:OpenGLTypesPlugin
 13.53%    2.624      1 Template:PageSyntax
 13.07%    2.534      1 Template:PageNavigation
 11.28%    2.188      1 Template:PageDescription
 10.75%    2.085      3 Template:Parameter
  9.25%    1.794      1 Template:PageSeeAlso
  9.18%    1.780      1 Template:FixedStart
  8.96%    1.737      1 Template:PageParameters
  8.72%    1.691      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:731-0!canonical and timestamp 20240714210848 and revision id 7033.
 -->
</div>
</div>
</div>
