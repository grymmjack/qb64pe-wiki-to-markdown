...
<head>
<title>_glFeedbackBuffer - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlFeedbackBuffer rootpage-GlFeedbackBuffer skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glFeedbackBuffer</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glFeedbackBuffer</b> statement controls feedback mode.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glFeedbackBuffer</a> GLsizei <i>size</i>, GLenum <i>type</i>, GLfloat <i>*buffer</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glfeedbackbuffer" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv" rel="nofollow">_glGet</a>, <a href="GlLineStipple" title="GlLineStipple">_glLineStipple</a></li>
<li><a href="GlPassThrough" title="GlPassThrough">_glPassThrough</a>, <a href="GlPolygonMode" title="GlPolygonMode">_glPolygonMode</a>, <a href="GlRenderMode" title="GlRenderMode">_glRenderMode</a>, <a href="GlSelectBuffer" title="GlSelectBuffer">_glSelectBuffer</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210634
Cache expiry: 86400
...
100.00%   23.034      1 -total
 33.51%    7.719      1 Template:OpenGLTypesPlugin
 11.97%    2.758      1 Template:PageSyntax
 10.87%    2.504      1 Template:FixedEnd
 10.69%    2.463      1 Template:PageDescription
 10.49%    2.416      1 Template:PageSeeAlso
 10.43%    2.403      3 Template:Parameter
  9.87%    2.274      1 Template:PageParameters
  9.65%    2.223      1 Template:FixedStart
  8.74%    2.013      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:827-0!canonical and timestamp 20240714210634 and revision id 6865.
 -->
</div>
</div>
</div>
