...
<head>
<title>_glStencilMask - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlStencilMask rootpage-GlStencilMask skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glStencilMask</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glStencilMask</b> statement controls the writing of individual bits in the stencil planes.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glStencilMask</a> GLuint <i>mask</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glstencilmask" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlColorMask" title="GlColorMask">_glColorMask</a>, <a href="GlDepthMask" title="GlDepthMask">_glDepthMask</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li>
<li><a href="GlIndexMask" title="GlIndexMask">_glIndexMask</a>, <a href="GlStencilFunc" title="GlStencilFunc">_glStencilFunc</a>, <a href="GlStencilOp" title="GlStencilOp">_glStencilOp</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210847
Cache expiry: 86400
...
100.00%   27.626      1 -total
 39.41%   10.886      1 Template:OpenGLTypesPlugin
 20.91%    5.777      1 Template:FixedStart
 11.20%    3.093      1 Template:PageSyntax
 10.23%    2.825      1 Template:Parameter
 10.04%    2.774      1 Template:FixedEnd
  9.92%    2.740      1 Template:PageParameters
  9.13%    2.521      1 Template:PageNavigation
  8.55%    2.361      1 Template:PageDescription
  8.40%    2.321      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:693-0!canonical and timestamp 20240714210847 and revision id 7032.
 -->
</div>
</div>
</div>
