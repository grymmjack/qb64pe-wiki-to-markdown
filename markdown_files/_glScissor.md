...
<head>
<title>_glScissor - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlScissor rootpage-GlScissor skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glScissor</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glScissor</b> statement defines the scissor box.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glScissor</a> GLint <i>x</i>, GLint <i>y</i>, GLsizei <i>width</i>, GLsizei <i>height</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glscissor" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnable" title="GlEnable">_glEnable</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlIsEnabled" title="GlIsEnabled">_glIsEnabled</a></li>
<li><a href="GlViewport" title="GlViewport">_glViewport</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714212413
Cache expiry: 86400
...
100.00%   34.150      1 -total
 35.53%   12.133      1 Template:OpenGLTypesPlugin
 15.30%    5.224      1 Template:PageSyntax
 13.18%    4.502      1 Template:FixedStart
 10.66%    3.640      1 Template:PageDescription
 10.19%    3.478      4 Template:Parameter
 10.01%    3.418      1 Template:FixedEnd
  9.53%    3.253      1 Template:PageSeeAlso
  8.28%    2.828      1 Template:PageParameters
  7.20%    2.459      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:695-0!canonical and timestamp 20240714212413 and revision id 7028.
 -->
</div>
</div>
</div>
