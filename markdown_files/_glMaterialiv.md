...
<head>
<title>_glMaterialiv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMaterialiv rootpage-GlMaterialiv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMaterialiv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMaterialiv</b> statement specifies material parameters for the lighting model.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMaterialiv</a> GLenum <i>face</i>, GLenum <i>pname</i>, const GLint <i>*params</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmaterialiv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlColorMaterial" title="GlColorMaterial">_glColorMaterial</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gllight-functions" rel="nofollow">_glLight</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gllightmodel-functions" rel="nofollow">_glLightModel</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714213404
Cache expiry: 86400
...
100.00%  106.525      1 -total
 35.66%   37.983      1 Template:OpenGLTypesPlugin
 15.02%   15.999      3 Template:Parameter
 14.84%   15.807      1 Template:PageParameters
 12.23%   13.029      1 Template:PageDescription
 11.47%   12.213      1 Template:FixedStart
 11.38%   12.120      1 Template:FixedEnd
  9.68%   10.314      1 Template:PageNavigation
  7.23%    7.697      1 Template:PageSyntax
  4.25%    4.524      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:988-0!canonical and timestamp 20240714213404 and revision id 6950.
 -->
</div>
</div>
</div>
