...
\_glGetString - QB64 Phoenix Edition Wiki
...
* The full description for this command can be found at [Microsoft Docs](https://learn.microsoft.com/en-us/windows/win32/opengl/glgetstring) and is also valid for QB64 usage.
...
* [\_glBegin](/qb64wiki/index.php/GlBegin "GlBegin"), [\_glEnd](/qb64wiki/index.php/GlEnd "GlEnd")
...
Retrieved from "<https://qb64phoenix.com/qb64wiki/index.php?title=GlGetString&oldid=6894>"
