...
<head>
<title>_glRenderMode - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlRenderMode rootpage-GlRenderMode skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glRenderMode</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glRenderMode</b> function sets the rasterization mode and returns the previous active mode.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd>GLint <i>result</i> = <a class="mw-selflink selflink">_glRenderMode</a> (GLenum <i>mode</i>)</dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glrendermode" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlFeedbackBuffer" title="GlFeedbackBuffer">_glFeedbackBuffer</a>, <a href="GlInitNames" title="GlInitNames">_glInitNames</a></li>
<li><a href="GlLoadName" title="GlLoadName">_glLoadName</a>, <a href="GlPassThrough" title="GlPassThrough">_glPassThrough</a>, <a href="GlPushName" title="GlPushName">_glPushName</a>, <a href="GlSelectBuffer" title="GlSelectBuffer">_glSelectBuffer</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210837
Cache expiry: 86400
...
100.00%   39.871      1 -total
 45.90%   18.302      1 Template:OpenGLTypesPlugin
 29.80%   11.880      1 Template:FixedEnd
  9.67%    3.855      1 Template:PageDescription
  9.40%    3.748      1 Template:PageSeeAlso
  8.78%    3.502      1 Template:PageSyntax
  8.30%    3.308      1 Template:PageNavigation
  7.74%    3.086      1 Template:PageParameters
  7.72%    3.079      1 Template:FixedStart
  6.64%    2.648      2 Template:Parameter
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1064-0!canonical and timestamp 20240714210837 and revision id 7023.
 -->
</div>
</div>
</div>
