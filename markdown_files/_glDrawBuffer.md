...
<head>
<title>_glDrawBuffer - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlDrawBuffer rootpage-GlDrawBuffer skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glDrawBuffer</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glDrawBuffer</b> statement specifies which color buffers are to be drawn into.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glDrawBuffer</a> GLenum <i>mode</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gldrawbuffer" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlBlendFunc" title="GlBlendFunc">_glBlendFunc</a>, <a href="GlColorMask" title="GlColorMask">_glColorMask</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li>
<li><a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv" rel="nofollow">_glGet</a>, <a href="GlIndexMask" title="GlIndexMask">_glIndexMask</a>, <a href="GlLogicOp" title="GlLogicOp">_glLogicOp</a>, <a href="GlReadBuffer" title="GlReadBuffer">_glReadBuffer</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714212151
Cache expiry: 86400
...
100.00%   25.591      1 -total
 32.07%    8.208      1 Template:OpenGLTypesPlugin
 13.78%    3.526      1 Template:PageSyntax
 10.78%    2.760      1 Template:Parameter
 10.09%    2.583      1 Template:PageParameters
  9.93%    2.541      1 Template:PageDescription
  9.82%    2.514      1 Template:PageNavigation
  9.76%    2.497      1 Template:FixedEnd
  9.66%    2.471      1 Template:FixedStart
  9.60%    2.456      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:694-0!canonical and timestamp 20240714212150 and revision id 6843.
 -->
</div>
</div>
</div>
