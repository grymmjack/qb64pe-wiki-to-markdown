...
<head>
<title>_glMap1f - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMap1f rootpage-GlMap1f skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMap1f</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMap1f</b> statement defines a one-dimensional evaluator.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMap1f</a> GLenum <i>target</i>, GLfloat <i>u1</i>, GLfloat <i>u2</i>, GLint <i>stride</i>, GLint <i>order</i>, const GLfloat <i>*points</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmap1f" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   24.150      1 -total
 26.32%    6.357      1 Template:OpenGLTypesPlugin
 13.60%    3.284      1 Template:PageDescription
 13.10%    3.164      1 Template:PageSyntax
 12.54%    3.028      6 Template:Parameter
 10.08%    2.435      1 Template:PageSeeAlso
  9.84%    2.377      1 Template:PageNavigation
  9.36%    2.260      1 Template:PageParameters
  7.97%    1.926      1 Template:FixedStart
  7.68%    1.854      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:982-0!canonical and timestamp 20240714213351 and revision id 6940.
 -->
</div>
</div>
</div>
