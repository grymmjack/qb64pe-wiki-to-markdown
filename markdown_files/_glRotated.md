...
<head>
<title>_glRotated - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlRotated rootpage-GlRotated skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glRotated</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glRotated</b> statement multiplies the current matrix by a rotation matrix.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glRotated</a> GLdouble <i>angle</i>, GLdouble <i>x</i>, GLdouble <i>y</i>, GLdouble <i>z</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glrotated" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
<li><a href="GlPopMatrix" title="GlPopMatrix">_glPopMatrix</a>, <a href="GlPushMatrix" title="GlPushMatrix">_glPushMatrix</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glscale" rel="nofollow">_glScale</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltranslate" rel="nofollow">_glTranslate</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714171748
Cache expiry: 86400
...
100.00%   26.232      1 -total
 28.59%    7.499      1 Template:OpenGLTypesPlugin
 19.47%    5.106      1 Template:PageSyntax
 10.93%    2.868      1 Template:PageParameters
 10.08%    2.644      4 Template:Parameter
  9.35%    2.452      1 Template:PageDescription
  9.27%    2.431      1 Template:FixedStart
  9.22%    2.418      1 Template:PageNavigation
  8.67%    2.275      1 Template:PageSeeAlso
  8.38%    2.198      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1065-0!canonical and timestamp 20240714171748 and revision id 7024.
 -->
</div>
</div>
</div>
