...
<head>
<title>_glGetClipPlane - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlGetClipPlane rootpage-GlGetClipPlane skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glGetClipPlane</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glGetClipPlane</b> statement returns the coefficients of the specified clipping plane.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glGetClipPlane</a> GLenum <i>plane</i>, GLdouble <i>*equation</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetclipplane" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlClipPlane" title="GlClipPlane">_glClipPlane</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210646
Cache expiry: 86400
...
100.00%   22.447      1 -total
 31.74%    7.125      1 Template:OpenGLTypesPlugin
 17.22%    3.865      1 Template:PageSyntax
 12.74%    2.859      1 Template:PageParameters
 11.06%    2.482      1 Template:FixedEnd
 10.25%    2.300      1 Template:FixedStart
  9.61%    2.158      1 Template:PageDescription
  9.04%    2.029      1 Template:PageSeeAlso
  8.92%    2.003      2 Template:Parameter
  7.13%    1.600      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:922-0!canonical and timestamp 20240714210646 and revision id 6877.
 -->
</div>
</div>
</div>
