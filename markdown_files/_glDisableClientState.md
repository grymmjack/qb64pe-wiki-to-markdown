...
<head>
<title>_glDisableClientState - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlDisableClientState rootpage-GlDisableClientState skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glDisableClientState</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glEnableClientState</b> and <b>_glDisableClientState</b> statements enable and disable arrays respectively.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glDisableClientState</a> GLenum <i>array</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gldisableclientstate" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
<li><a href="GlDrawElements" title="GlDrawElements">_glDrawElements</a>, <a href="GlEdgeFlagPointer" title="GlEdgeFlagPointer">_glEdgeFlagPointer</a>, <a href="GlEnable" title="GlEnable">_glEnable</a>, <a href="GlEnableClientState" title="GlEnableClientState">_glEnableClientState</a></li>
<li><a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlGetPointerv" title="GlGetPointerv">_glGetPointerv</a>, <a href="GlIndexPointer" title="GlIndexPointer">_glIndexPointer</a>, <a href="GlInterleavedArrays" title="GlInterleavedArrays">_glInterleavedArrays</a></li>
...
100.00%   21.024      1 -total
 34.89%    7.335      1 Template:OpenGLTypesPlugin
 13.24%    2.784      1 Template:FixedStart
 11.99%    2.520      1 Template:PageSyntax
 11.19%    2.353      1 Template:PageDescription
 10.06%    2.116      1 Template:Parameter
  9.68%    2.035      1 Template:PageParameters
  9.31%    1.957      1 Template:PageSeeAlso
  9.11%    1.916      1 Template:FixedEnd
  8.93%    1.878      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:866-0!canonical and timestamp 20240714093108 and revision id 6841.
 -->
</div>
</div>
</div>
