...
<head>
<title>_glEvalMesh2 - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlEvalMesh2 rootpage-GlEvalMesh2 skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glEvalMesh2</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glEvalMesh2</b> statement computes a two-dimensional grid of points or lines.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glEvalMesh2</a> GLenum <i>mode</i>, GLint <i>i1</i>, GLint <i>i2</i>, GLint <i>j1</i>, GLint <i>j2</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glevalmesh2" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210631
Cache expiry: 86400
...
100.00%   32.868      1 -total
 29.50%    9.697      1 Template:OpenGLTypesPlugin
 19.83%    6.518      1 Template:PageSyntax
 15.94%    5.239      1 Template:PageParameters
 12.35%    4.059      1 Template:FixedStart
  8.99%    2.956      5 Template:Parameter
  7.51%    2.469      1 Template:PageNavigation
  7.41%    2.436      1 Template:PageSeeAlso
  7.05%    2.317      1 Template:FixedEnd
  6.79%    2.232      1 Template:PageDescription
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:913-0!canonical and timestamp 20240714210631 and revision id 6862.
 -->
</div>
</div>
</div>
