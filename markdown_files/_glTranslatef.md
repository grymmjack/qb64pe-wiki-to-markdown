...
<head>
<title>_glTranslatef - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTranslatef rootpage-GlTranslatef skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTranslatef</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTranslatef</b> statement multiplies the current matrix by a translation matrix.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTranslatef</a> GLfloat <i>x</i>, GLfloat <i>y</i>, GLfloat <i>z</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltranslatef" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   16.273      1 -total
 31.09%    5.060      1 Template:OpenGLTypesPlugin
 15.23%    2.478      3 Template:Parameter
 13.23%    2.153      1 Template:PageSyntax
 10.15%    1.652      1 Template:FixedStart
  9.43%    1.534      1 Template:PageDescription
  9.42%    1.533      1 Template:PageParameters
  8.95%    1.456      1 Template:FixedEnd
  8.89%    1.447      1 Template:PageNavigation
  8.79%    1.431      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1118-0!canonical and timestamp 20240715033946 and revision id 7086.
 -->
</div>
</div>
</div>
