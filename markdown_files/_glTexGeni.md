...
<head>
<title>_glTexGeni - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexGeni rootpage-GlTexGeni skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexGeni</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexGeni</b> statement controls the generation of texture coordinates.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexGeni</a> GLenum <i>coord</i>, GLenum <i>pname</i>, GLint <i>param</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexgeni" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   17.792      1 -total
 33.46%    5.953      1 Template:OpenGLTypesPlugin
 12.08%    2.150      1 Template:PageSyntax
 11.00%    1.957      3 Template:Parameter
 10.59%    1.885      1 Template:PageDescription
 10.13%    1.803      1 Template:FixedStart
  9.86%    1.754      1 Template:PageParameters
  9.57%    1.703      1 Template:FixedEnd
  9.49%    1.689      1 Template:PageSeeAlso
  9.48%    1.687      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1109-0!canonical and timestamp 20240714213554 and revision id 7075.
 -->
</div>
</div>
</div>
