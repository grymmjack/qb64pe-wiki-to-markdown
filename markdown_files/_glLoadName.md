...
<head>
<title>_glLoadName - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlLoadName rootpage-GlLoadName skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glLoadName</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glLoadName</b> statement loads a name onto the name stack.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glLoadName</a> GLuint <i>name</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glloadname" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlInitNames" title="GlInitNames">_glInitNames</a>, <a href="GlPushName" title="GlPushName">_glPushName</a></li>
...
100.00%   23.745      1 -total
 32.95%    7.823      1 Template:OpenGLTypesPlugin
 14.86%    3.529      1 Template:PageSyntax
 10.91%    2.591      1 Template:Parameter
 10.11%    2.400      1 Template:FixedStart
 10.07%    2.392      1 Template:PageDescription
  9.96%    2.365      1 Template:FixedEnd
  9.63%    2.287      1 Template:PageParameters
  9.04%    2.147      1 Template:PageSeeAlso
  8.90%    2.114      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:979-0!canonical and timestamp 20240714210733 and revision id 6937.
 -->
</div>
</div>
</div>
