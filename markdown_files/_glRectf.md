...
<head>
<title>_glRectf - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlRectf rootpage-GlRectf skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glRectf</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glRectf</b> statement draws a rectangle.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glRectf</a> GLfloat <i>x1</i>, GLfloat <i>y1</i>, GLfloat <i>x2</i>, GLfloat <i>y2</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glrectf" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   55.437      1 -total
 33.47%   18.552      1 Template:OpenGLTypesPlugin
 22.13%   12.267      1 Template:PageDescription
 10.60%    5.875      1 Template:PageSeeAlso
 10.56%    5.854      1 Template:PageParameters
  8.56%    4.744      1 Template:FixedStart
  8.15%    4.518      1 Template:PageSyntax
  8.00%    4.432      4 Template:Parameter
  6.66%    3.694      1 Template:FixedEnd
  4.83%    2.675      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1058-0!canonical and timestamp 20240714213501 and revision id 7017.
 -->
</div>
</div>
</div>
