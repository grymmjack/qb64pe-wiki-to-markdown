...
<head>
<title>_glLightModelf - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlLightModelf rootpage-GlLightModelf skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glLightModelf</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glLightModelf</b> statement sets lighting model parameters.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glLightModelf</a> GLenum <i>pname</i>, GLfloat <i>*param</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gllightmodelf" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   27.618      1 -total
 36.51%   10.084      1 Template:OpenGLTypesPlugin
 13.72%    3.789      1 Template:PageSyntax
 13.54%    3.738      1 Template:FixedEnd
 10.56%    2.916      1 Template:FixedStart
  9.86%    2.722      2 Template:Parameter
  9.82%    2.712      1 Template:PageParameters
  9.12%    2.519      1 Template:PageSeeAlso
  8.79%    2.428      1 Template:PageNavigation
  8.78%    2.424      1 Template:PageDescription
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:969-0!canonical and timestamp 20240714213337 and revision id 6923.
 -->
</div>
</div>
</div>
