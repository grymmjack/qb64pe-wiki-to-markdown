...
<head>
<title>_glColor4ui - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlColor4ui rootpage-GlColor4ui skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glColor4ui</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glColor4ui</b> statement sets the current color.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glColor4ui</a> GLuint <i>red</i>, GLuint <i>green</i>, GLuint <i>blue</i>, GLuint <i>alpha</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glcolor4ui" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   20.758      1 -total
 34.83%    7.230      1 Template:OpenGLTypesPlugin
 11.14%    2.312      1 Template:PageSyntax
 10.96%    2.276      1 Template:FixedStart
 10.22%    2.122      1 Template:PageParameters
 10.13%    2.102      1 Template:FixedEnd
 10.09%    2.094      1 Template:PageNavigation
 10.05%    2.086      1 Template:PageDescription
  9.81%    2.036      4 Template:Parameter
  9.71%    2.015      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:895-0!canonical and timestamp 20240714063252 and revision id 6822.
 -->
</div>
</div>
</div>
