...
<head>
<title>_glClearColor - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlClearColor rootpage-GlClearColor skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glClearColor</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glClearColor</b> statement specifies clear values for the color buffers.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glClearColor</a> GLclampf <i>red</i>, GLclampf <i>green</i>, GLclampf <i>blue</i>, GLclampf <i>alpha</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glclearcolor" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   21.414      1 -total
 36.75%    7.870      1 Template:OpenGLTypesPlugin
 10.89%    2.332      1 Template:PageSyntax
 10.78%    2.309      1 Template:PageParameters
 10.38%    2.223      1 Template:FixedStart
 10.18%    2.180      1 Template:FixedEnd
  9.83%    2.104      1 Template:PageDescription
  9.55%    2.046      1 Template:PageNavigation
  9.09%    1.947      1 Template:PageSeeAlso
  9.07%    1.943      4 Template:Parameter
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:688-0!canonical and timestamp 20240714204345 and revision id 6789.
 -->
</div>
</div>
</div>
