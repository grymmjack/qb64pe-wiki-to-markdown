...
<head>
<title>_glViewport - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlViewport rootpage-GlViewport skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glViewport</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glViewport</b> statement sets the viewport.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glViewport</a> GLint <i>x</i>, GLint <i>y</i>, GLsizei <i>width</i>, GLsizei <i>height</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glviewport" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlDepthRange" title="GlDepthRange">_glDepthRange</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210952
Cache expiry: 86400
...
100.00%   27.201      1 -total
 41.37%   11.254      1 Template:OpenGLTypesPlugin
 14.86%    4.041      1 Template:FixedStart
 11.49%    3.125      1 Template:PageSyntax
 10.72%    2.916      4 Template:Parameter
  9.25%    2.517      1 Template:PageParameters
  8.21%    2.233      1 Template:FixedEnd
  8.00%    2.177      1 Template:PageNavigation
  7.76%    2.112      1 Template:PageDescription
  7.57%    2.059      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:736-0!canonical and timestamp 20240714210952 and revision id 7112.
 -->
</div>
</div>
</div>
