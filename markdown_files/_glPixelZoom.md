...
<head>
<title>_glPixelZoom - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlPixelZoom rootpage-GlPixelZoom skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glPixelZoom</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glPixelZoom</b> statement specifies the pixel zoom factors.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glPixelZoom</a> GLfloat <i>xfactor</i>, GLfloat <i>yfactor</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glpixelzoom" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlCopyPixels" title="GlCopyPixels">_glCopyPixels</a>, <a href="GlDrawPixels" title="GlDrawPixels">_glDrawPixels</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714212330
Cache expiry: 86400
...
100.00%   24.845      1 -total
 32.53%    8.081      1 Template:OpenGLTypesPlugin
 20.12%    5.000      1 Template:PageNavigation
 12.20%    3.032      1 Template:FixedStart
  9.70%    2.410      1 Template:PageSyntax
  8.82%    2.191      1 Template:PageSeeAlso
  8.76%    2.177      2 Template:Parameter
  8.62%    2.141      1 Template:PageDescription
  8.15%    2.024      1 Template:PageParameters
  7.64%    1.899      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1009-0!canonical and timestamp 20240714212330 and revision id 6975.
 -->
</div>
</div>
</div>
