...
<head>
<title>_glTexGenf - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexGenf rootpage-GlTexGenf skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexGenf</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexGenf</b> statement controls the generation of texture coordinates.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexGenf</a> GLenum <i>coord</i>, GLenum <i>pname</i>, GLfloat <i>param</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexgenf" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   21.148      1 -total
 31.20%    6.598      1 Template:OpenGLTypesPlugin
 14.54%    3.074      1 Template:PageSyntax
 11.99%    2.536      1 Template:PageNavigation
 11.85%    2.507      3 Template:Parameter
  9.80%    2.073      1 Template:PageParameters
  9.45%    1.998      1 Template:FixedEnd
  8.73%    1.846      1 Template:FixedStart
  8.62%    1.822      1 Template:PageDescription
  8.39%    1.774      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1111-0!canonical and timestamp 20240714213553 and revision id 7073.
 -->
</div>
</div>
</div>
