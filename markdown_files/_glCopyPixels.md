...
<head>
<title>_glCopyPixels - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlCopyPixels rootpage-GlCopyPixels skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glCopyPixels</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glCopyPixels</b> statement copies pixels in the framebuffer.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glCopyPixels</a> GLint <i>x</i>, GLint <i>y</i>, GLsizei <i>width</i>, GLsizei <i>height</i>, GLenum <i>type</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glcopypixels" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlDepthFunc" title="GlDepthFunc">_glDepthFunc</a>, <a href="GlDrawBuffer" title="GlDrawBuffer">_glDrawBuffer</a>, <a href="GlDrawPixels" title="GlDrawPixels">_glDrawPixels</a></li>
...
<li><a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glpixeltransfer" rel="nofollow">_glPixelTransfer</a>, <a href="GlPixelZoom" title="GlPixelZoom">_glPixelZoom</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glrasterpos-functions" rel="nofollow">_glRasterPos</a>, <a href="GlReadBuffer" title="GlReadBuffer">_glReadBuffer</a></li>
<li><a href="GlReadPixels" title="GlReadPixels">_glReadPixels</a>, <a href="GlStencilFunc" title="GlStencilFunc">_glStencilFunc</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714213220
Cache expiry: 86400
...
100.00%   24.407      1 -total
 33.24%    8.112      1 Template:OpenGLTypesPlugin
 11.91%    2.907      1 Template:PageSyntax
 10.71%    2.614      5 Template:Parameter
 10.43%    2.545      1 Template:PageDescription
 10.20%    2.490      1 Template:FixedEnd
 10.08%    2.460      1 Template:FixedStart
  9.83%    2.398      1 Template:PageSeeAlso
  9.76%    2.383      1 Template:PageParameters
  9.60%    2.344      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:863-0!canonical and timestamp 20240714213220 and revision id 6829.
 -->
</div>
</div>
</div>
