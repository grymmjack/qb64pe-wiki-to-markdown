...
<head>
<title>_glDrawElements - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlDrawElements rootpage-GlDrawElements skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glDrawElements</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glDrawElements</b> statement renders primitives from array data.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glDrawElements</a> GLenum <i>mode</i>, GLsizei <i>count</i>, GLenum <i>type</i>, const GLvoid <i>*indices</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gldrawelements" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
<li><a href="GlEdgeFlagPointer" title="GlEdgeFlagPointer">_glEdgeFlagPointer</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlGetPointerv" title="GlGetPointerv">_glGetPointerv</a>, <a href="GlIndexPointer" title="GlIndexPointer">_glIndexPointer</a></li>
...
100.00%   20.102      1 -total
 33.18%    6.669      1 Template:OpenGLTypesPlugin
 12.07%    2.427      1 Template:PageSeeAlso
 11.71%    2.354      1 Template:PageParameters
 10.56%    2.123      1 Template:PageNavigation
 10.39%    2.088      4 Template:Parameter
  9.36%    1.882      1 Template:FixedStart
  9.11%    1.832      1 Template:PageDescription
  8.81%    1.771      1 Template:FixedEnd
  8.78%    1.765      1 Template:PageSyntax
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:710-0!canonical and timestamp 20240714212151 and revision id 6844.
 -->
</div>
</div>
</div>
