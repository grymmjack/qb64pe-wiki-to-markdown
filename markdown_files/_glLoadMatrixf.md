...
<head>
<title>_glLoadMatrixf - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlLoadMatrixf rootpage-GlLoadMatrixf skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glLoadMatrixf</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glLoadMatrixf</b> statement replaces the current matrix with an arbitrary matrix.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glLoadMatrixf</a> const GLfloat <i>*m</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glloadmatrixf" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   25.774      1 -total
 30.17%    7.775      1 Template:OpenGLTypesPlugin
 17.16%    4.424      1 Template:PageSyntax
 10.69%    2.756      1 Template:Parameter
 10.68%    2.753      1 Template:PageParameters
  9.88%    2.546      1 Template:PageSeeAlso
  9.04%    2.329      1 Template:PageNavigation
  8.59%    2.213      1 Template:PageDescription
  8.55%    2.204      1 Template:FixedStart
  8.38%    2.160      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:978-0!canonical and timestamp 20240714213348 and revision id 6936.
 -->
</div>
</div>
</div>
