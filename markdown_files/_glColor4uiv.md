...
<head>
<title>_glColor4uiv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlColor4uiv rootpage-GlColor4uiv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glColor4uiv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glColor4uiv</b> statement sets the current color from an already existing array of color values.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glColor4uiv</a> const GLuint <i>*v</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glcolor4uiv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   27.426      1 -total
 31.46%    8.629      1 Template:OpenGLTypesPlugin
 13.45%    3.688      1 Template:PageSyntax
 11.76%    3.225      1 Template:Parameter
 10.39%    2.850      1 Template:PageDescription
 10.06%    2.758      1 Template:PageParameters
  9.91%    2.718      1 Template:FixedStart
  9.55%    2.620      1 Template:PageNavigation
  9.51%    2.607      1 Template:PageSeeAlso
  9.19%    2.520      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:896-0!canonical and timestamp 20240714213215 and revision id 6823.
 -->
</div>
</div>
</div>
