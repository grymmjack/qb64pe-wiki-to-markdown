...
<head>
<title>_glPushName - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlPushName rootpage-GlPushName skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glPushName</h1>
...
<dl><dd><a class="mw-selflink selflink">_glPushName</a> GLuint <i>name</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glpushname" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   54.460      1 -total
 33.07%   18.008      1 Template:OpenGLTypesPlugin
 18.28%    9.957      1 Template:PageNavigation
 15.00%    8.169      1 Template:PageDescription
 14.77%    8.042      1 Template:FixedEnd
 13.53%    7.368      1 Template:PageSeeAlso
  6.24%    3.399      1 Template:PageSyntax
  5.88%    3.201      1 Template:FixedStart
  5.35%    2.914      1 Template:Parameter
  5.06%    2.755      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1022-0!canonical and timestamp 20240714210811 and revision id 6988.
 -->
</div>
</div>
</div>
