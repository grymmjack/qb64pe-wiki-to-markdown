...
<head>
<title>_glDrawPixels - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlDrawPixels rootpage-GlDrawPixels skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glDrawPixels</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glDrawPixels</b> statement writes a block of pixels to the framebuffer.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glDrawPixels</a> GLsizei <i>width</i>, GLsizei <i>height</i>, GLenum <i>format</i>, GLenum <i>type</i>, const GLvoid <i>*pixels</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gldrawpixels" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlAlphaFunc" title="GlAlphaFunc">_glAlphaFunc</a>, <a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlBlendFunc" title="GlBlendFunc">_glBlendFunc</a>, <a href="GlCopyPixels" title="GlCopyPixels">_glCopyPixels</a></li>
<li><a href="GlDepthFunc" title="GlDepthFunc">_glDepthFunc</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv" rel="nofollow">_glGet</a>, <a href="GlLogicOp" title="GlLogicOp">_glLogicOp</a></li>
...
<li><a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glrasterpos-functions" rel="nofollow">_glRasterPos</a>, <a href="GlReadPixels" title="GlReadPixels">_glReadPixels</a>, <a href="GlScissor" title="GlScissor">_glScissor</a>, <a href="GlStencilFunc" title="GlStencilFunc">_glStencilFunc</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240715032817
Cache expiry: 86400
...
Post‐expand include size: 6927/2097152 bytes
...
100.00%   17.353      1 -total
 33.11%    5.745      1 Template:OpenGLTypesPlugin
 12.09%    2.098      1 Template:PageSyntax
 11.48%    1.993      5 Template:Parameter
 10.60%    1.839      1 Template:PageParameters
 10.05%    1.744      1 Template:FixedStart
  9.92%    1.721      1 Template:PageSeeAlso
  9.49%    1.646      1 Template:FixedEnd
  9.37%    1.626      1 Template:PageNavigation
  8.86%    1.538      1 Template:PageDescription
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:867-0!canonical and timestamp 20240715032817 and revision id 6845.
 -->
</div>
</div>
</div>
