...
<head>
<title>_glCallList - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlCallList rootpage-GlCallList skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glCallList</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glCallList</b> statement executes a display list.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glCallList</a> GLuint <i>list</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glcalllist" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlCallLists" title="GlCallLists">_glCallLists</a>, <a href="GlDeleteLists" title="GlDeleteLists">_glDeleteLists</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li>
<li><a href="GlGenLists" title="GlGenLists">_glGenLists</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv" rel="nofollow">_glGet</a>, <a href="GlIsList" title="GlIsList">_glIsList</a>, <a href="GlNewList" title="GlNewList">_glNewList</a></li>
<li><a href="GlPopAttrib" title="GlPopAttrib">_glPopAttrib</a>, <a href="GlPopMatrix" title="GlPopMatrix">_glPopMatrix</a>, <a href="GlPushAttrib" title="GlPushAttrib">_glPushAttrib</a>, <a href="GlPushMatrix" title="GlPushMatrix">_glPushMatrix</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210217
Cache expiry: 86400
...
100.00%   31.019      1 -total
 27.77%    8.614      1 Template:OpenGLTypesPlugin
 27.28%    8.463      1 Template:PageNavigation
  9.46%    2.935      1 Template:PageSyntax
  8.55%    2.653      1 Template:Parameter
  8.30%    2.576      1 Template:FixedStart
  8.26%    2.562      1 Template:PageParameters
  7.96%    2.470      1 Template:PageDescription
  7.93%    2.460      1 Template:FixedEnd
  7.71%    2.391      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:852-0!canonical and timestamp 20240714210217 and revision id 6785.
 -->
</div>
</div>
</div>
