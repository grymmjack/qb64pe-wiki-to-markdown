...
<head>
<title>_glFrustum - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlFrustum rootpage-GlFrustum skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glFrustum</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glFrustum</b> statement multiplies the current matrix by a perspective matrix.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glFrustum</a> GLdouble <i>left</i>, GLdouble <i>right</i>, GLdouble <i>bottom</i>, GLdouble <i>top</i>, GLdouble <i>zNear</i>, GLdouble <i>zFar</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glfrustum" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv" rel="nofollow">_glGet</a>, <a href="GlMatrixMode" title="GlMatrixMode">_glMatrixMode</a></li>
<li><a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmultmatrix" rel="nofollow">_glMultMatrix</a>, <a href="GlOrtho" title="GlOrtho">_glOrtho</a>, <a href="GlPopMatrix" title="GlPopMatrix">_glPopMatrix</a>, <a href="GlPushMatrix" title="GlPushMatrix">_glPushMatrix</a></li>
<li><a href="GlViewport" title="GlViewport">_glViewport</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240715033001
Cache expiry: 86400
...
Post‐expand include size: 6930/2097152 bytes
...
100.00%   18.356      1 -total
 38.20%    7.013      1 Template:OpenGLTypesPlugin
 13.01%    2.388      1 Template:FixedStart
 10.87%    1.995      1 Template:PageParameters
 10.86%    1.994      1 Template:FixedEnd
 10.37%    1.904      1 Template:PageSyntax
 10.10%    1.854      1 Template:PageSeeAlso
  9.44%    1.732      1 Template:PageNavigation
  9.12%    1.674      6 Template:Parameter
  7.68%    1.410      1 Template:PageDescription
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:900-0!canonical and timestamp 20240715033001 and revision id 6873.
 -->
</div>
</div>
</div>
