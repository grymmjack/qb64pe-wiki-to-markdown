...
<head>
<title>_glIsTexture - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlIsTexture rootpage-GlIsTexture skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glIsTexture</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glIsTexture</b> function determines if a name corresponds to a texture.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd>GLboolean <i>result</i> = <a class="mw-selflink selflink">_glIsTexture</a> (GLuint <i>texture</i>)</dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glistexture" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlBindTexture" title="GlBindTexture">_glBindTexture</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlGenTextures" title="GlGenTextures">_glGenTextures</a></li>
<li><a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv" rel="nofollow">_glGet</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgettexparameter" rel="nofollow">_glGetTexParameter</a>, <a href="GlTexImage1D" title="GlTexImage1D">_glTexImage1D</a>, <a href="GlTexImage2D" title="GlTexImage2D">_glTexImage2D</a></li>
...
100.00%   26.511      1 -total
 28.77%    7.626      1 Template:OpenGLTypesPlugin
 17.33%    4.595      1 Template:PageParameters
 12.73%    3.375      1 Template:PageDescription
 10.45%    2.771      1 Template:PageSyntax
  9.69%    2.568      1 Template:PageSeeAlso
  9.30%    2.465      1 Template:PageNavigation
  9.04%    2.396      1 Template:FixedStart
  8.32%    2.206      2 Template:Parameter
  8.16%    2.162      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:721-0!canonical and timestamp 20240714210723 and revision id 6922.
 -->
</div>
</div>
</div>
