...
<head>
<title>_glMapGrid2f - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMapGrid2f rootpage-GlMapGrid2f skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMapGrid2f</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMapGrid2f</b> statement defines a two-dimensional mesh.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMapGrid2f</a> GLint <i>un</i>, GLfloat <i>u1</i>, GLfloat <i>u2</i>, GLint <i>vn</i>, GLfloat <i>v1</i>, GLfloat <i>v2</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmapgrid2f" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   28.307      1 -total
 31.80%    9.002      1 Template:OpenGLTypesPlugin
 17.63%    4.990      1 Template:PageSyntax
 11.91%    3.372      1 Template:PageSeeAlso
 10.95%    3.099      1 Template:FixedEnd
  9.98%    2.826      6 Template:Parameter
  9.22%    2.611      1 Template:FixedStart
  8.74%    2.474      1 Template:PageParameters
  7.92%    2.241      1 Template:PageNavigation
  7.54%    2.134      1 Template:PageDescription
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:984-0!canonical and timestamp 20240714213357 and revision id 6946.
 -->
</div>
</div>
</div>
