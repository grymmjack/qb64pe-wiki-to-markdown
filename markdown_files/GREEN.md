...
* rgbaColorIndex& is the [RGBA](RGBA.md) color value or palette index of the color to retrieve the green component intensity from.
...
* If imageHandle& is not specified, it is assumed to be the current write page (See _DEST ).
