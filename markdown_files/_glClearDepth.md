...
<head>
<title>_glClearDepth - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlClearDepth rootpage-GlClearDepth skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glClearDepth</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glClearDepth</b> statement specifies the clear value for the depth buffer.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glClearDepth</a> GLclampd <i>depth</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glcleardepth" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   16.581      1 -total
 36.34%    6.026      1 Template:OpenGLTypesPlugin
 13.62%    2.258      1 Template:PageSyntax
 11.48%    1.904      1 Template:FixedEnd
 11.01%    1.826      1 Template:FixedStart
 10.67%    1.770      1 Template:PageParameters
 10.66%    1.767      1 Template:Parameter
  8.55%    1.417      1 Template:PageNavigation
  8.36%    1.387      1 Template:PageDescription
  8.23%    1.364      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:689-0!canonical and timestamp 20240714174134 and revision id 6790.
 -->
</div>
</div>
</div>
