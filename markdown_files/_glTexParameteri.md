...
<head>
<title>_glTexParameteri - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexParameteri rootpage-GlTexParameteri skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexParameteri</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexParameteri</b> statement sets texture parameters.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexParameteri</a> GLenum <i>target</i>, GLenum <i>pname</i>, GLint <i>param</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexparameteri" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   15.970      1 -total
 32.47%    5.185      1 Template:OpenGLTypesPlugin
 12.62%    2.016      1 Template:PageSyntax
 10.99%    1.755      3 Template:Parameter
 10.33%    1.650      1 Template:PageParameters
 10.19%    1.628      1 Template:PageDescription
  9.81%    1.566      1 Template:PageNavigation
  9.79%    1.564      1 Template:FixedStart
  9.75%    1.557      1 Template:PageSeeAlso
  9.63%    1.538      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1115-0!canonical and timestamp 20240714213559 and revision id 7081.
 -->
</div>
</div>
</div>
