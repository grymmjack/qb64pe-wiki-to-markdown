...
* integerOffset contains the offset from the current code segment, set by DEF SEG and [SADD](SADD.md) , to the starting location of the called procedure.
* QBasic and QB64 have the ABSOLUTE statement built in and require no library, like QuickBASIC did.
* NOTE: QB64 does not support [INT](INT.md) 33h mouse functions above 3 or [BYVAL](BYVAL.md) in an ABSOLUTE statement. Registers are emulated.
