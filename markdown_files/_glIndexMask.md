...
<head>
<title>_glIndexMask - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlIndexMask rootpage-GlIndexMask skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glIndexMask</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glIndexMask</b> statement controls the writing of individual bits in the color-index buffers.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glIndexMask</a> GLuint <i>mask</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glindexmask" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlDepthMask" title="GlDepthMask">_glDepthMask</a>, <a href="GlDrawBuffer" title="GlDrawBuffer">_glDrawBuffer</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li>
<li><a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glindex-functions" rel="nofollow">_glIndex</a>, <a href="GlStencilMask" title="GlStencilMask">_glStencilMask</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210711
Cache expiry: 86400
...
100.00%   22.678      1 -total
 33.03%    7.491      1 Template:OpenGLTypesPlugin
 11.94%    2.708      1 Template:PageSyntax
 10.80%    2.450      1 Template:PageSeeAlso
 10.20%    2.314      1 Template:Parameter
 10.18%    2.308      1 Template:PageDescription
 10.12%    2.294      1 Template:PageNavigation
 10.10%    2.290      1 Template:FixedEnd
  9.99%    2.266      1 Template:PageParameters
  9.87%    2.238      1 Template:FixedStart
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:950-0!canonical and timestamp 20240714210711 and revision id 6906.
 -->
</div>
</div>
</div>
