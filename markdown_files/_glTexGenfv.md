...
<head>
<title>_glTexGenfv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexGenfv rootpage-GlTexGenfv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexGenfv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexGenfv</b> statement controls the generation of texture coordinates.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexGenfv</a> GLenum <i>coord</i>, GLenum <i>pname</i>, const GLfloat <i>*params</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexgenfv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   24.453      1 -total
 34.15%    8.350      1 Template:OpenGLTypesPlugin
 12.38%    3.028      1 Template:FixedStart
 11.68%    2.855      1 Template:PageParameters
 11.12%    2.718      1 Template:PageSyntax
 10.88%    2.660      1 Template:PageDescription
  9.65%    2.360      3 Template:Parameter
  9.49%    2.320      1 Template:FixedEnd
  9.34%    2.284      1 Template:PageSeeAlso
  9.18%    2.245      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1110-0!canonical and timestamp 20240714213553 and revision id 7074.
 -->
</div>
</div>
</div>
