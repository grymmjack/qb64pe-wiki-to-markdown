...
<head>
<title>_glMateriali - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMateriali rootpage-GlMateriali skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMateriali</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMateriali</b> statement specifies material parameters for the lighting model.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMateriali</a> GLenum <i>face</i>, GLenum <i>pname</i>, GLint <i>param</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmateriali" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   23.810      1 -total
 33.52%    7.982      1 Template:OpenGLTypesPlugin
 11.27%    2.684      1 Template:PageSyntax
 11.24%    2.677      3 Template:Parameter
 10.68%    2.542      1 Template:FixedStart
 10.48%    2.496      1 Template:PageSeeAlso
 10.26%    2.442      1 Template:PageParameters
 10.04%    2.390      1 Template:FixedEnd
  9.70%    2.309      1 Template:PageNavigation
  9.32%    2.220      1 Template:PageDescription
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:989-0!canonical and timestamp 20240714213402 and revision id 6949.
 -->
</div>
</div>
</div>
