...
<head>
<title>_glEvalMesh1 - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlEvalMesh1 rootpage-GlEvalMesh1 skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glEvalMesh1</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glEvalMesh1</b> statement computes a one-dimensional grid of points or lines.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glEvalMesh1</a> GLenum <i>mode</i>, GLint <i>i1</i>, GLint <i>i2</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glevalmesh1" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   20.963      1 -total
 30.42%    6.378      1 Template:OpenGLTypesPlugin
 15.06%    3.158      1 Template:PageSyntax
 12.57%    2.636      3 Template:Parameter
 12.13%    2.543      1 Template:PageParameters
  8.52%    1.785      1 Template:PageDescription
  8.50%    1.781      1 Template:FixedStart
  8.46%    1.774      1 Template:FixedEnd
  8.42%    1.766      1 Template:PageNavigation
  8.31%    1.743      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:912-0!canonical and timestamp 20240714210630 and revision id 6861.
 -->
</div>
</div>
</div>
