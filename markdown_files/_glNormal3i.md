...
<head>
<title>_glNormal3i - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlNormal3i rootpage-GlNormal3i skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glNormal3i</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glNormal3i</b> statement sets the current normal vector.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glNormal3i</a> GLint <i>nx</i>, GLint <i>ny</i>, GLint <i>nz</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glnormal3i" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   18.573      1 -total
 34.68%    6.442      1 Template:OpenGLTypesPlugin
 11.27%    2.094      1 Template:PageSyntax
 10.67%    1.982      1 Template:FixedStart
 10.53%    1.956      3 Template:Parameter
 10.23%    1.900      1 Template:FixedEnd
 10.23%    1.900      1 Template:PageDescription
  9.84%    1.827      1 Template:PageSeeAlso
  9.73%    1.807      1 Template:PageParameters
  9.65%    1.793      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1002-0!canonical and timestamp 20240714213414 and revision id 6961.
 -->
</div>
</div>
</div>
