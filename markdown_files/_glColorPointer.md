...
<head>
<title>_glColorPointer - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlColorPointer rootpage-GlColorPointer skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glColorPointer</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glColorPointer</b> statement defines an array of colors.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glColorPointer</a> GLint <i>size</i>, GLenum <i>type</i>, GLsizei <i>stride</i>, const GLvoid <i>*pointer</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glcolorpointer" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlArrayElement" title="GlArrayElement">_glArrayElement</a>, <a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlDrawArrays" title="GlDrawArrays">_glDrawArrays</a>, <a href="GlEdgeFlagPointer" title="GlEdgeFlagPointer">_glEdgeFlagPointer</a></li>
<li><a href="GlEnableClientState" title="GlEnableClientState">_glEnableClientState</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv" rel="nofollow">_glGet</a>, <a href="GlGetString" title="GlGetString">_glGetString</a></li>
<li><a href="GlGetPointerv" title="GlGetPointerv">_glGetPointerv</a>, <a href="GlIndexPointer" title="GlIndexPointer">_glIndexPointer</a>, <a href="GlIsEnabled" title="GlIsEnabled">_glIsEnabled</a>, <a href="GlNormalPointer" title="GlNormalPointer">_glNormalPointer</a></li>
...
100.00%   21.257      1 -total
 32.40%    6.887      1 Template:OpenGLTypesPlugin
 12.98%    2.759      1 Template:PageSyntax
 11.33%    2.408      4 Template:Parameter
 10.48%    2.228      1 Template:PageParameters
  9.82%    2.087      1 Template:PageSeeAlso
  9.78%    2.079      1 Template:FixedStart
  9.41%    2.000      1 Template:PageNavigation
  9.16%    1.948      1 Template:FixedEnd
  8.73%    1.855      1 Template:PageDescription
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:862-0!canonical and timestamp 20240714211728 and revision id 6828.
 -->
</div>
</div>
</div>
