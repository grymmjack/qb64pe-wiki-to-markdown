...
* _glEdgeFlagPointer , _glEnd , _glEvalCoord , _glEvalMesh
* _glEvalPoint , _glFog , _glGet , _glIndexPointer
* _glIsEnabled , _glLight , _glLightModel , _glLineWidth
* _glLineStipple , _glLogicOp , _glMap1 , _glMap2
* _glMaterial , _glNormal , _glNormalPointer , _glPointSize
* _glPolygonMode , _glPolygonStipple , _glScissor , _glStencilFunc
* _glStencilOp , _glTexCoordPointer , _glTexGen , _glTexImage1D
* _glTexImage2D
</blockquote>
