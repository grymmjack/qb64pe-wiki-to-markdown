...
<head>
<title>_glColor3ubv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlColor3ubv rootpage-GlColor3ubv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glColor3ubv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glColor3ubv</b> statement sets the current color from an already existing array of color values.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glColor3ubv</a> const GLubyte <i>*v</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glcolor3ubv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   18.160      1 -total
 36.70%    6.664      1 Template:OpenGLTypesPlugin
 12.23%    2.221      1 Template:FixedStart
 11.27%    2.046      1 Template:PageSyntax
 10.39%    1.887      1 Template:PageNavigation
 10.06%    1.827      1 Template:PageParameters
  9.91%    1.800      1 Template:PageSeeAlso
  9.35%    1.697      1 Template:PageDescription
  9.17%    1.665      1 Template:FixedEnd
  9.13%    1.658      1 Template:Parameter
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:878-0!canonical and timestamp 20240714213159 and revision id 6805.
 -->
</div>
</div>
</div>
