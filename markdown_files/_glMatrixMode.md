...
<head>
<title>_glMatrixMode - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMatrixMode rootpage-GlMatrixMode skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMatrixMode</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMatrixMode</b> statement specifies which matrix is the current matrix.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMatrixMode</a> GLenum <i>mode</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmatrixmode" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glloadmatrix" rel="nofollow">_glLoadMatrix</a>, <a href="GlPushMatrix" title="GlPushMatrix">_glPushMatrix</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210743
Cache expiry: 86400
...
100.00%   33.763      1 -total
 43.56%   14.707      1 Template:OpenGLTypesPlugin
 16.92%    5.713      1 Template:FixedEnd
 10.02%    3.384      1 Template:PageSyntax
  9.72%    3.280      1 Template:PageSeeAlso
  9.59%    3.237      1 Template:PageDescription
  8.50%    2.870      1 Template:Parameter
  8.47%    2.860      1 Template:FixedStart
  7.96%    2.686      1 Template:PageNavigation
  7.76%    2.619      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:994-0!canonical and timestamp 20240714210743 and revision id 6951.
 -->
</div>
</div>
</div>
