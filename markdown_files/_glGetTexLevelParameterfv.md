...
<head>
<title>_glGetTexLevelParameterfv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlGetTexLevelParameterfv rootpage-GlGetTexLevelParameterfv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glGetTexLevelParameterfv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glGetTexLevelParameterfv</b> and <b>_glGetTexLevelParameteriv</b> statements return texture parameter values for a specific level of detail.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glGetTexLevelParameterfv</a> GLenum <i>target</i>, GLint <i>level</i>, GLenum <i>pname</i>, GLfloat <i>*params</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgettexlevelparameterfv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgettexparameter" rel="nofollow">_glGetTexParameter</a>, <a href="GlTexImage1D" title="GlTexImage1D">_glTexImage1D</a></li>
...
Post‐expand include size: 6918/2097152 bytes
...
100.00%   23.146      1 -total
 37.59%    8.700      1 Template:OpenGLTypesPlugin
 16.94%    3.920      1 Template:FixedEnd
 11.64%    2.695      1 Template:PageSyntax
 10.61%    2.456      4 Template:Parameter
  9.93%    2.299      1 Template:PageDescription
  9.67%    2.238      1 Template:PageParameters
  8.90%    2.059      1 Template:FixedStart
  8.39%    1.942      1 Template:PageNavigation
  8.36%    1.936      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:946-0!canonical and timestamp 20240714213321 and revision id 6901.
 -->
</div>
</div>
</div>
