...
<head>
<title>_glGetError - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlGetError rootpage-GlGetError skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glGetError</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glGetError</b> function returns error information.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd>GLenum <i>result</i> = <a class="mw-selflink selflink">_glGetError</a></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgeterror" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   25.692      1 -total
 33.12%    8.508      1 Template:OpenGLTypesPlugin
 11.75%    3.018      1 Template:Parameter
 11.51%    2.957      1 Template:PageParameters
 11.40%    2.929      1 Template:PageSyntax
 10.72%    2.754      1 Template:FixedEnd
  9.67%    2.485      1 Template:PageNavigation
  9.61%    2.469      1 Template:PageDescription
  9.59%    2.465      1 Template:FixedStart
  9.25%    2.377      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:716-0!canonical and timestamp 20240714210648 and revision id 6879.
 -->
</div>
</div>
</div>
