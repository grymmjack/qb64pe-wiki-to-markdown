...
<head>
<title>_glNormal3bv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlNormal3bv rootpage-GlNormal3bv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glNormal3bv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glNormal3bv</b> statement sets the current normal vector.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glNormal3bv</a> const GLbyte <i>*v</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glnormal3bv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   20.039      1 -total
 33.04%    6.621      1 Template:OpenGLTypesPlugin
 11.76%    2.357      1 Template:PageSyntax
 10.87%    2.178      1 Template:PageParameters
 10.75%    2.154      1 Template:Parameter
 10.45%    2.094      1 Template:FixedStart
 10.30%    2.063      1 Template:PageDescription
 10.00%    2.003      1 Template:PageNavigation
  9.35%    1.873      1 Template:PageSeeAlso
  8.86%    1.775      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:999-0!canonical and timestamp 20240715032040 and revision id 6956.
 -->
</div>
</div>
</div>
