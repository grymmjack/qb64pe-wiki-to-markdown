...
<head>
<title>_glLightiv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlLightiv rootpage-GlLightiv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glLightiv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glLightiv</b> statement returns light source parameter values.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glLightiv</a> GLenum <i>light</i>, GLenum <i>pname</i>, const GLint <i>*params</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gllightiv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   21.950      1 -total
 27.96%    6.137      1 Template:OpenGLTypesPlugin
 20.93%    4.595      1 Template:PageSyntax
 15.46%    3.393      3 Template:Parameter
  9.70%    2.128      1 Template:FixedStart
  8.60%    1.887      1 Template:PageParameters
  7.89%    1.731      1 Template:PageSeeAlso
  7.81%    1.715      1 Template:PageDescription
  7.73%    1.697      1 Template:FixedEnd
  7.62%    1.673      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:970-0!canonical and timestamp 20240714213343 and revision id 6930.
 -->
</div>
</div>
</div>
