...
<head>
<title>_glMultMatrixf - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMultMatrixf rootpage-GlMultMatrixf skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMultMatrixf</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMultMatrixf</b> statement multiplies the current matrix by an arbitrary matrix.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMultMatrixf</a> const GLfloat <i>*m</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmultmatrixf" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlLoadIdentity" title="GlLoadIdentity">_glLoadIdentity</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glloadmatrix" rel="nofollow">_glLoadMatrix</a></li>
<li><a href="GlMatrixMode" title="GlMatrixMode">_glMatrixMode</a>, <a href="GlPushMatrix" title="GlPushMatrix">_glPushMatrix</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714213407
Cache expiry: 86400
...
100.00%   60.550      1 -total
 56.14%   33.995      1 Template:OpenGLTypesPlugin
 19.31%   11.695      1 Template:FixedStart
 16.02%    9.702      1 Template:FixedEnd
 14.74%    8.924      1 Template:PageSyntax
 14.53%    8.800      1 Template:PageDescription
  3.67%    2.225      1 Template:Parameter
  3.66%    2.214      1 Template:PageSeeAlso
  3.32%    2.012      1 Template:PageNavigation
  2.89%    1.752      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:992-0!canonical and timestamp 20240714213407 and revision id 6953.
 -->
</div>
</div>
</div>
