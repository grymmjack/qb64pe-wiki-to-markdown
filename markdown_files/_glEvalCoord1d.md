...
<head>
<title>_glEvalCoord1d - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlEvalCoord1d rootpage-GlEvalCoord1d skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glEvalCoord1d</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glEvalCoord1d</b> statement evaluates enabled one-dimensional maps.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glEvalCoord1d</a> GLdouble <i>u</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glevalcoord1d" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   22.999      1 -total
 35.09%    8.071      1 Template:OpenGLTypesPlugin
 11.52%    2.650      1 Template:PageSyntax
 11.06%    2.544      1 Template:FixedStart
 10.34%    2.378      1 Template:PageParameters
 10.17%    2.340      1 Template:PageDescription
 10.14%    2.331      1 Template:FixedEnd
 10.02%    2.304      1 Template:Parameter
  9.86%    2.268      1 Template:PageNavigation
  9.25%    2.127      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:904-0!canonical and timestamp 20240714213244 and revision id 6853.
 -->
</div>
</div>
</div>
