...
<head>
<title>_glDepthFunc - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlDepthFunc rootpage-GlDepthFunc skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glDepthFunc</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glDepthFunc</b> statement specifies the value used for depth-buffer comparisons.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glDepthFunc</a> GLenum <i>func</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gldepthfunc" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlDepthRange" title="GlDepthRange">_glDepthRange</a>, <a href="GlEnable" title="GlEnable">_glEnable</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li>
<li><a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv" rel="nofollow">_glGet</a>, <a href="GlIsEnabled" title="GlIsEnabled">_glIsEnabled</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210612
Cache expiry: 86400
...
100.00%   22.529      1 -total
 33.45%    7.536      1 Template:OpenGLTypesPlugin
 12.23%    2.755      1 Template:PageParameters
 12.11%    2.729      1 Template:PageSyntax
 11.17%    2.516      1 Template:FixedStart
 10.47%    2.359      1 Template:PageDescription
 10.29%    2.318      1 Template:Parameter
 10.00%    2.253      1 Template:FixedEnd
  9.97%    2.246      1 Template:PageSeeAlso
  7.90%    1.780      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:707-0!canonical and timestamp 20240714210612 and revision id 6837.
 -->
</div>
</div>
</div>
