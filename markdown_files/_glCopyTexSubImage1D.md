...
<head>
<title>_glCopyTexSubImage1D - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlCopyTexSubImage1D rootpage-GlCopyTexSubImage1D skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glCopyTexSubImage1D</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glCopyTexSubImage1D</b> statement copies a sub-image of a one-dimensional texture image from the framebuffer.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glCopyTexSubImage1D</a> GLenum <i>target</i>, GLint <i>level</i>, GLint <i>xoffset</i>, GLint <i>x</i>, GLint <i>y</i>, GLsizei <i>width</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glcopytexsubimage1d" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlCopyTexSubImage2D" title="GlCopyTexSubImage2D">_glCopyTexSubImage2D</a>, <a href="GlDrawPixels" title="GlDrawPixels">_glDrawPixels</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li>
...
<li><a href="GlTexSubImage2D" title="GlTexSubImage2D">_glTexSubImage2D</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexparameter-functions" rel="nofollow">_glTexParameter</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240715054958
Cache expiry: 86400
...
100.00%   34.281      1 -total
 39.87%   13.669      1 Template:OpenGLTypesPlugin
 14.98%    5.135      1 Template:FixedEnd
 12.79%    4.384      1 Template:PageParameters
 12.16%    4.168      1 Template:PageSyntax
  9.96%    3.416      6 Template:Parameter
  9.61%    3.295      1 Template:PageDescription
  9.12%    3.128      1 Template:FixedStart
  6.73%    2.307      1 Template:PageSeeAlso
  5.73%    1.966      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:703-0!canonical and timestamp 20240715054958 and revision id 6832.
 -->
</div>
</div>
</div>
