...
<head>
<title>_glFrontFace - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlFrontFace rootpage-GlFrontFace skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glFrontFace</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glFrontFace</b> statement defines front-facing and back-facing polygons.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glFrontFace</a> GLenum <i>mode</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glfrontface" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlCullFace" title="GlCullFace">_glCullFace</a>, <a href="GlDisable" title="GlDisable">_glDisable</a>, <a href="GlEnable" title="GlEnable">_glEnable</a></li>
...
100.00%   26.520      1 -total
 31.35%    8.313      1 Template:OpenGLTypesPlugin
 21.84%    5.793      1 Template:PageNavigation
 12.36%    3.278      1 Template:FixedStart
 10.47%    2.778      1 Template:PageSeeAlso
  9.05%    2.401      1 Template:PageSyntax
  8.29%    2.198      1 Template:FixedEnd
  8.26%    2.191      1 Template:Parameter
  8.17%    2.168      1 Template:PageDescription
  7.50%    1.989      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:714-0!canonical and timestamp 20240714210640 and revision id 6872.
 -->
</div>
</div>
</div>
