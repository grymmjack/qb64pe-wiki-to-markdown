...
<head>
<title>_glTexGeniv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexGeniv rootpage-GlTexGeniv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexGeniv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexGeniv</b> statement controls the generation of texture coordinates.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexGeniv</a> GLenum <i>coord</i>, GLenum <i>pname</i>, const GLint <i>*params</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexgeniv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   19.140      1 -total
 31.48%    6.025      1 Template:OpenGLTypesPlugin
 14.43%    2.763      1 Template:PageSeeAlso
 11.77%    2.252      1 Template:PageSyntax
 11.45%    2.191      1 Template:PageNavigation
  9.48%    1.814      3 Template:Parameter
  9.39%    1.797      1 Template:FixedStart
  8.98%    1.719      1 Template:FixedEnd
  8.91%    1.705      1 Template:PageDescription
  8.15%    1.559      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1108-0!canonical and timestamp 20240715031438 and revision id 7076.
 -->
</div>
</div>
</div>
