...
<head>
<title>_glTexParameterf - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexParameterf rootpage-GlTexParameterf skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexParameterf</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexParameterf</b> statement sets texture parameters.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexParameterf</a> GLenum <i>target</i>, GLenum <i>pname</i>, GLfloat <i>param</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexparameterf" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   17.911      1 -total
 39.89%    7.145      1 Template:OpenGLTypesPlugin
 19.36%    3.467      1 Template:FixedStart
 10.65%    1.907      1 Template:PageDescription
 10.19%    1.826      1 Template:PageSyntax
  9.25%    1.657      1 Template:PageNavigation
  9.10%    1.629      1 Template:PageSeeAlso
  9.02%    1.616      3 Template:Parameter
  8.76%    1.569      1 Template:FixedEnd
  8.30%    1.487      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1117-0!canonical and timestamp 20240715031440 and revision id 7079.
 -->
</div>
</div>
</div>
