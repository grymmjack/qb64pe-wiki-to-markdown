...
<head>
<title>_glRasterPos2fv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlRasterPos2fv rootpage-GlRasterPos2fv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glRasterPos2fv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glRasterPos2fv</b> statement specifies the raster position for pixel operations.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glRasterPos2fv</a> const GLfloat <i>*v</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glrasterpos2fv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   23.839      1 -total
 31.78%    7.575      1 Template:OpenGLTypesPlugin
 13.45%    3.207      1 Template:PageNavigation
 11.41%    2.720      1 Template:PageSyntax
 11.21%    2.673      1 Template:Parameter
  9.76%    2.326      1 Template:FixedEnd
  9.63%    2.295      1 Template:PageParameters
  9.61%    2.290      1 Template:PageSeeAlso
  9.54%    2.274      1 Template:PageDescription
  8.43%    2.010      1 Template:FixedStart
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1032-0!canonical and timestamp 20240714212343 and revision id 6992.
 -->
</div>
</div>
</div>
