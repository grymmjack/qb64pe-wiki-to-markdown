...
<head>
<title>_glPixelMapfv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlPixelMapfv rootpage-GlPixelMapfv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glPixelMapfv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glPixelMapfv</b> statement sets up pixel transfer maps.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glPixelMapfv</a> GLenum <i>map</i>, GLsizei <i>mapsize</i>, const GLfloat <i>*values</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glpixelmapfv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   21.546      1 -total
 27.06%    5.831      1 Template:OpenGLTypesPlugin
 25.87%    5.575      1 Template:PageSyntax
 11.02%    2.375      3 Template:Parameter
  8.56%    1.845      1 Template:PageParameters
  8.51%    1.833      1 Template:PageDescription
  8.42%    1.815      1 Template:FixedEnd
  8.18%    1.762      1 Template:FixedStart
  8.00%    1.724      1 Template:PageSeeAlso
  7.77%    1.674      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1012-0!canonical and timestamp 20240714213420 and revision id 6968.
 -->
</div>
</div>
</div>
