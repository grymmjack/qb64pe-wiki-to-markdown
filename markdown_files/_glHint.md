...
<head>
<title>_glHint - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlHint rootpage-GlHint skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glHint</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glHint</b> statement specifies implementation-specific hints.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glHint</a> GLenum <i>target</i>, GLenum <i>mode</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glhint" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   18.848      1 -total
 33.32%    6.281      1 Template:OpenGLTypesPlugin
 12.64%    2.382      1 Template:PageSyntax
 11.51%    2.170      1 Template:PageParameters
 10.78%    2.032      1 Template:FixedEnd
 10.74%    2.025      2 Template:Parameter
 10.31%    1.944      1 Template:FixedStart
  9.44%    1.780      1 Template:PageDescription
  9.34%    1.761      1 Template:PageNavigation
  9.30%    1.753      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:719-0!canonical and timestamp 20240714210710 and revision id 6905.
 -->
</div>
</div>
</div>
