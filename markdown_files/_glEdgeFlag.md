...
<head>
<title>_glEdgeFlag - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlEdgeFlag rootpage-GlEdgeFlag skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glEdgeFlag</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glEdgeFlag</b> statement flags edges as either boundary or nonboundary.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glEdgeFlag</a> GLboolean <i>flag</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gledgeflag" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714212153
Cache expiry: 86400
...
100.00%   17.531      1 -total
 32.54%    5.704      1 Template:OpenGLTypesPlugin
 13.22%    2.317      1 Template:PageSyntax
 11.01%    1.930      1 Template:Parameter
 10.74%    1.882      1 Template:PageParameters
 10.22%    1.791      1 Template:PageNavigation
  9.94%    1.742      1 Template:FixedStart
  9.78%    1.715      1 Template:PageDescription
  9.56%    1.676      1 Template:FixedEnd
  8.95%    1.569      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:868-0!canonical and timestamp 20240714212153 and revision id 6846.
 -->
</div>
</div>
</div>
