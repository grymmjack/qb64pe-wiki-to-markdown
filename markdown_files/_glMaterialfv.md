...
<head>
<title>_glMaterialfv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMaterialfv rootpage-GlMaterialfv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMaterialfv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMaterialfv</b> statement specifies material parameters for the lighting model.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMaterialfv</a> GLenum <i>face</i>, GLenum <i>pname</i>, const GLfloat <i>*params</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmaterialfv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   28.118      1 -total
 33.67%    9.467      1 Template:OpenGLTypesPlugin
 12.69%    3.568      1 Template:PageSyntax
 10.83%    3.046      1 Template:FixedStart
 10.79%    3.033      1 Template:PageDescription
 10.74%    3.021      1 Template:FixedEnd
 10.30%    2.895      3 Template:Parameter
  9.62%    2.704      1 Template:PageNavigation
  9.60%    2.698      1 Template:PageSeeAlso
  9.16%    2.576      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:990-0!canonical and timestamp 20240714063602 and revision id 6948.
 -->
</div>
</div>
</div>
