...
<head>
<title>_glVertex4f - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlVertex4f rootpage-GlVertex4f skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glVertex4f</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glVertex4f</b> statement specifies a vertex.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glVertex4f</a> GLfloat <i>x</i>, GLfloat <i>y</i>, GLfloat <i>z</i>, GLfloat <i>w</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glvertex4f" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   20.734      1 -total
 32.19%    6.674      1 Template:OpenGLTypesPlugin
 12.96%    2.687      1 Template:PageSyntax
 11.36%    2.355      1 Template:FixedEnd
 10.72%    2.222      4 Template:Parameter
 10.68%    2.214      1 Template:PageDescription
 10.07%    2.088      1 Template:PageSeeAlso
  9.19%    1.906      1 Template:PageNavigation
  9.13%    1.893      1 Template:PageParameters
  9.11%    1.888      1 Template:FixedStart
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1142-0!canonical and timestamp 20240714213620 and revision id 7105.
 -->
</div>
</div>
</div>
