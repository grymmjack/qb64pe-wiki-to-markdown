...
<head>
<title>_glReadBuffer - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlReadBuffer rootpage-GlReadBuffer skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glReadBuffer</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glReadBuffer</b> statement selects a color buffer source for pixels.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glReadBuffer</a> GLenum <i>mode</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glreadbuffer" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlCopyPixels" title="GlCopyPixels">_glCopyPixels</a>, <a href="GlDrawBuffer" title="GlDrawBuffer">_glDrawBuffer</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li>
<li><a href="GlReadPixels" title="GlReadPixels">_glReadPixels</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714213458
Cache expiry: 86400
...
100.00%   42.682      1 -total
 35.32%   15.076      1 Template:PageSyntax
 30.59%   13.056      1 Template:OpenGLTypesPlugin
 18.36%    7.838      1 Template:FixedStart
 13.20%    5.635      1 Template:Parameter
  5.97%    2.547      1 Template:PageParameters
  4.74%    2.021      1 Template:FixedEnd
  4.66%    1.991      1 Template:PageNavigation
  4.44%    1.896      1 Template:PageDescription
  4.06%    1.733      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:727-0!canonical and timestamp 20240714213458 and revision id 7013.
 -->
</div>
</div>
</div>
