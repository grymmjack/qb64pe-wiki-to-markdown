...
<head>
<title>_glTexEnvfv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexEnvfv rootpage-GlTexEnvfv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexEnvfv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexEnvfv</b> statement sets a texture environment parameter.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexEnvfv</a> GLenum <i>target</i>, GLenum <i>pname</i>, const GLfloat <i>*params</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexenvfv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   17.820      1 -total
 42.41%    7.558      1 Template:OpenGLTypesPlugin
 17.23%    3.071      1 Template:FixedStart
 10.22%    1.821      1 Template:PageSeeAlso
  9.87%    1.758      1 Template:PageSyntax
  9.69%    1.726      1 Template:FixedEnd
  8.73%    1.556      1 Template:PageDescription
  8.61%    1.534      1 Template:PageNavigation
  8.59%    1.530      3 Template:Parameter
  7.90%    1.408      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1106-0!canonical and timestamp 20240714213548 and revision id 7068.
 -->
</div>
</div>
</div>
