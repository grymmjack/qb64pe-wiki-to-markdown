...
<head>
<title>_glLineStipple - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlLineStipple rootpage-GlLineStipple skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glLineStipple</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glLineStipple</b> statement specifies the line stipple pattern.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glLineStipple</a> GLint <i>factor</i>, GLushort <i>pattern</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gllinestipple" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlLineWidth" title="GlLineWidth">_glLineWidth</a>, <a href="GlPolygonStipple" title="GlPolygonStipple">_glPolygonStipple</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240715033048
Cache expiry: 86400
...
100.00%   15.982      1 -total
 34.40%    5.498      1 Template:OpenGLTypesPlugin
 13.35%    2.133      1 Template:PageSyntax
 11.13%    1.779      1 Template:FixedStart
 10.43%    1.667      1 Template:FixedEnd
 10.31%    1.648      2 Template:Parameter
  9.96%    1.591      1 Template:PageSeeAlso
  9.65%    1.542      1 Template:PageDescription
  9.58%    1.532      1 Template:PageParameters
  9.25%    1.478      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:974-0!canonical and timestamp 20240715033048 and revision id 6931.
 -->
</div>
</div>
</div>
