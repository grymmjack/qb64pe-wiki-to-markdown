...
<head>
<title>_glClearIndex - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlClearIndex rootpage-GlClearIndex skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glClearIndex</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glClearIndex</b> statement specifies the clear value for the color-index buffers.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glClearIndex</a> GLfloat <i>c</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glclearindex" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   18.815      1 -total
 35.34%    6.649      1 Template:OpenGLTypesPlugin
 12.63%    2.377      1 Template:PageSyntax
 10.26%    1.930      1 Template:PageDescription
 10.20%    1.920      1 Template:FixedStart
 10.11%    1.903      1 Template:PageParameters
  9.91%    1.865      1 Template:Parameter
  9.80%    1.843      1 Template:FixedEnd
  9.33%    1.756      1 Template:PageNavigation
  9.32%    1.754      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:855-0!canonical and timestamp 20240714204348 and revision id 6791.
 -->
</div>
</div>
</div>
