...
<head>
<title>_glAreTexturesResident - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlAreTexturesResident rootpage-GlAreTexturesResident skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glAreTexturesResident</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glAreTexturesResident</b> function determines whether specified texture objects are resident in texture memory.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd>GLboolean <i>result</i> = <a class="mw-selflink selflink">_glAreTexturesResident</a> (GLsizei <i>n</i>, const GLuint <i>*textures</i>, GLboolean <i>*residences</i>)</dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glaretexturesresident" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlBindTexture" title="GlBindTexture">_glBindTexture</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgettexparameter" rel="nofollow">_glGetTexParameter</a></li>
<li><a href="GlPrioritizeTextures" title="GlPrioritizeTextures">_glPrioritizeTextures</a>, <a href="GlTexImage1D" title="GlTexImage1D">_glTexImage1D</a>, <a href="GlTexImage2D" title="GlTexImage2D">_glTexImage2D</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210241
Cache expiry: 86400
...
Post‐expand include size: 6922/2097152 bytes
...
100.00%   22.031      1 -total
 30.54%    6.728      1 Template:OpenGLTypesPlugin
 13.54%    2.982      1 Template:PageSyntax
 11.56%    2.546      4 Template:Parameter
 10.16%    2.239      1 Template:PageParameters
 10.01%    2.206      1 Template:PageNavigation
  9.94%    2.191      1 Template:PageDescription
  9.19%    2.025      1 Template:PageSeeAlso
  8.75%    1.928      1 Template:FixedEnd
  8.52%    1.876      1 Template:FixedStart
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:845-0!canonical and timestamp 20240714210241 and revision id 6779.
 -->
</div>
</div>
</div>
