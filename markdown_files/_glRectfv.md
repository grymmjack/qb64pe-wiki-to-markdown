...
<head>
<title>_glRectfv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlRectfv rootpage-GlRectfv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glRectfv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glRectfv</b> statement draws a rectangle.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glRectfv</a> const GLfloat <i>*v1</i>, const GLfloat <i>*v2</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glrectfv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   23.457      1 -total
 30.24%    7.093      1 Template:OpenGLTypesPlugin
 14.27%    3.348      1 Template:PageNavigation
 13.46%    3.157      1 Template:PageParameters
 10.98%    2.575      1 Template:PageSeeAlso
 10.03%    2.352      2 Template:Parameter
  9.85%    2.311      1 Template:FixedStart
  9.62%    2.257      1 Template:PageSyntax
  9.08%    2.129      1 Template:FixedEnd
  8.49%    1.992      1 Template:PageDescription
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1059-0!canonical and timestamp 20240714213503 and revision id 7018.
 -->
</div>
</div>
</div>
