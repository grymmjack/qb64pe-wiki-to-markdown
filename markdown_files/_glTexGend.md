...
<head>
<title>_glTexGend - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexGend rootpage-GlTexGend skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexGend</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexGend</b> statement controls the generation of texture coordinates.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexGend</a> GLenum <i>coord</i>, GLenum <i>pname</i>, GLdouble <i>param</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexgend" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   31.645      1 -total
 40.14%   12.702      1 Template:PageSyntax
 18.37%    5.814      1 Template:OpenGLTypesPlugin
 13.20%    4.177      3 Template:Parameter
 11.42%    3.613      1 Template:PageParameters
  5.62%    1.778      1 Template:FixedStart
  5.09%    1.611      1 Template:PageNavigation
  5.02%    1.590      1 Template:FixedEnd
  5.00%    1.581      1 Template:PageSeeAlso
  4.60%    1.457      1 Template:PageDescription
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1113-0!canonical and timestamp 20240714213551 and revision id 7071.
 -->
</div>
</div>
</div>
