...
<head>
<title>_glMap2d - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMap2d rootpage-GlMap2d skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMap2d</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMap2d</b> statement defines a two-dimensional evaluator.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMap2d</a> GLenum <i>target</i>, GLdouble <i>u1</i>, GLdouble <i>u2</i>, GLint <i>ustride</i>, GLint <i>uorder</i>, GLdouble <i>v1</i>, GLdouble <i>v2</i>, GLint <i>vstride</i>, GLint <i>vorder</i>, const GLdouble <i>*points</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmap2d" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glcolor-functions" rel="nofollow">_glColor</a>, <a href="GlEnable" title="GlEnable">_glEnable</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li>
...
100.00%   36.612      1 -total
 43.58%   15.955      1 Template:OpenGLTypesPlugin
 11.95%    4.375      1 Template:PageParameters
 11.51%    4.213      1 Template:FixedEnd
  9.62%    3.521      1 Template:PageSyntax
  9.59%    3.511      1 Template:PageDescription
  7.76%    2.841      1 Template:FixedStart
  7.75%    2.838     10 Template:Parameter
  6.89%    2.524      1 Template:PageSeeAlso
  6.87%    2.516      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:981-0!canonical and timestamp 20240714213352 and revision id 6941.
 -->
</div>
</div>
</div>
