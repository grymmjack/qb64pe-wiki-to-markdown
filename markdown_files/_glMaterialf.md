...
<head>
<title>_glMaterialf - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMaterialf rootpage-GlMaterialf skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMaterialf</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMaterialf</b> statement specifies material parameters for the lighting model.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMaterialf</a> GLenum <i>face</i>, GLenum <i>pname</i>, GLfloat <i>param</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmaterialf" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   32.516      1 -total
 30.11%    9.791      1 Template:OpenGLTypesPlugin
 19.41%    6.310      1 Template:PageSyntax
 11.52%    3.745      1 Template:FixedStart
 10.90%    3.543      3 Template:Parameter
 10.40%    3.381      1 Template:PageDescription
  9.75%    3.169      1 Template:FixedEnd
  9.39%    3.052      1 Template:PageSeeAlso
  8.73%    2.838      1 Template:PageNavigation
  7.44%    2.418      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:991-0!canonical and timestamp 20240714213358 and revision id 6947.
 -->
</div>
</div>
</div>
