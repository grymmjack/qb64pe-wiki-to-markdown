...
<head>
<title>_glListBase - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlListBase rootpage-GlListBase skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glListBase</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glListBase</b> statement sets the display list base for <b>_glCallLists</b>.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glListBase</a> GLuint <i>base</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gllistbase" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlCallLists" title="GlCallLists">_glCallLists</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714213345
Cache expiry: 86400
...
100.00%   41.073      1 -total
 40.30%   16.552      1 Template:PageSyntax
 21.75%    8.932      1 Template:OpenGLTypesPlugin
 12.74%    5.231      1 Template:Parameter
  7.09%    2.913      1 Template:PageParameters
  6.10%    2.507      1 Template:FixedEnd
  5.80%    2.382      1 Template:FixedStart
  5.76%    2.366      1 Template:PageDescription
  5.48%    2.249      1 Template:PageNavigation
  4.90%    2.012      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:975-0!canonical and timestamp 20240714213345 and revision id 6933.
 -->
</div>
</div>
</div>
