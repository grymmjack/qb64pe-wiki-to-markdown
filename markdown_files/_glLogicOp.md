...
<head>
<title>_glLogicOp - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlLogicOp rootpage-GlLogicOp skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glLogicOp</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glLogicOp</b> statement specifies a logical pixel operation for color index rendering.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glLogicOp</a> GLenum <i>opcode</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gllogicop" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlAlphaFunc" title="GlAlphaFunc">_glAlphaFunc</a>, <a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlBlendFunc" title="GlBlendFunc">_glBlendFunc</a>, <a href="GlDrawBuffer" title="GlDrawBuffer">_glDrawBuffer</a></li>
<li><a href="GlEnable" title="GlEnable">_glEnable</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlIsEnabled" title="GlIsEnabled">_glIsEnabled</a>, <a href="GlStencilOp" title="GlStencilOp">_glStencilOp</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210734
Cache expiry: 86400
...
100.00%   18.670      1 -total
 32.05%    5.984      1 Template:OpenGLTypesPlugin
 12.88%    2.405      1 Template:PageSyntax
 11.02%    2.058      1 Template:Parameter
 10.99%    2.052      1 Template:PageParameters
 10.57%    1.973      1 Template:FixedStart
 10.05%    1.877      1 Template:PageNavigation
  9.73%    1.816      1 Template:PageDescription
  9.13%    1.704      1 Template:PageSeeAlso
  8.81%    1.644      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:723-0!canonical and timestamp 20240714210734 and revision id 6938.
 -->
</div>
</div>
</div>
