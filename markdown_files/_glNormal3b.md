...
<head>
<title>_glNormal3b - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlNormal3b rootpage-GlNormal3b skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glNormal3b</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glNormal3b</b> statement sets the current normal vector.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glNormal3b</a> GLbyte <i>nx</i>, GLbyte <i>ny</i>, GLbyte <i>nz</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glnormal3b" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   14.638      1 -total
 36.67%    5.367      1 Template:OpenGLTypesPlugin
 13.42%    1.965      1 Template:PageSyntax
 12.23%    1.790      1 Template:FixedEnd
 11.31%    1.655      1 Template:FixedStart
 10.19%    1.492      3 Template:Parameter
  9.43%    1.380      1 Template:PageParameters
  9.01%    1.319      1 Template:PageDescription
  8.61%    1.261      1 Template:PageNavigation
  8.61%    1.260      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1000-0!canonical and timestamp 20240715032039 and revision id 6955.
 -->
</div>
</div>
</div>
