...
<head>
<title>_glTexCoord3d - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexCoord3d rootpage-GlTexCoord3d skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexCoord3d</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexCoord3d</b> statement sets the current texture coordinates.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexCoord3d</a> GLdouble <i>s</i>, GLdouble <i>t</i>, GLdouble <i>r</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexcoord3d" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   20.533      1 -total
 30.99%    6.364      1 Template:OpenGLTypesPlugin
 21.02%    4.317      3 Template:Parameter
  9.95%    2.042      1 Template:PageDescription
  9.66%    1.984      1 Template:FixedStart
  9.62%    1.976      1 Template:PageParameters
  9.17%    1.882      1 Template:FixedEnd
  8.40%    1.725      1 Template:PageNavigation
  8.40%    1.724      1 Template:PageSeeAlso
  8.22%    1.687      1 Template:PageSyntax
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1087-0!canonical and timestamp 20240714201155 and revision id 7050.
 -->
</div>
</div>
</div>
