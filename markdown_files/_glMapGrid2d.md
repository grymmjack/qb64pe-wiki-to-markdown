...
<head>
<title>_glMapGrid2d - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMapGrid2d rootpage-GlMapGrid2d skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMapGrid2d</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMapGrid2d</b> statement defines a two-dimensional mesh.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMapGrid2d</a> GLint <i>un</i>, GLdouble <i>u1</i>, GLdouble <i>u2</i>, GLint <i>vn</i>, GLdouble <i>v1</i>, GLdouble <i>v2</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmapgrid2d" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
Post‐expand include size: 6915/2097152 bytes
...
100.00%   20.567      1 -total
 29.90%    6.150      1 Template:OpenGLTypesPlugin
 15.12%    3.110      1 Template:PageSyntax
 11.23%    2.310      1 Template:PageNavigation
 11.05%    2.273      1 Template:PageDescription
 10.49%    2.158      1 Template:PageSeeAlso
  9.83%    2.022      1 Template:FixedEnd
  9.64%    1.982      6 Template:Parameter
  9.33%    1.919      1 Template:FixedStart
  8.74%    1.798      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:985-0!canonical and timestamp 20240714151830 and revision id 6945.
 -->
</div>
</div>
</div>
