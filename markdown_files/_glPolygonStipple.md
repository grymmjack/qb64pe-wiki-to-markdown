...
<head>
<title>_glPolygonStipple - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlPolygonStipple rootpage-GlPolygonStipple skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glPolygonStipple</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glPolygonStipple</b> statement sets the polygon stippling pattern.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glPolygonStipple</a> const GLubyte <i>*mask</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glpolygonstipple" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlDrawPixels" title="GlDrawPixels">_glDrawPixels</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlLineStipple" title="GlLineStipple">_glLineStipple</a></li>
<li><a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glpixelstore-functions" rel="nofollow">_glPixelStore</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glpixeltransfer" rel="nofollow">_glPixelTransfer</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210804
Cache expiry: 86400
...
100.00%   74.004      1 -total
 37.33%   27.624      1 Template:OpenGLTypesPlugin
 20.26%   14.990      1 Template:PageParameters
 15.42%   11.409      1 Template:FixedStart
 11.10%    8.214      1 Template:PageNavigation
 10.38%    7.685      1 Template:Parameter
  9.08%    6.722      1 Template:PageSyntax
  6.44%    4.763      1 Template:PageSeeAlso
  4.12%    3.046      1 Template:PageDescription
  3.56%    2.636      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1018-0!canonical and timestamp 20240714210804 and revision id 6979.
 -->
</div>
</div>
</div>
