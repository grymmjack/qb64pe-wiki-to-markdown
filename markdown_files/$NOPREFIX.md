...
* If you are writing new code with QB64, and not importing code from QBasic/QuickBASIC 4.5 nor any 3rd party .bi/.bm style libraries, then [\$NOPREFIX](\$NOPREFIX.md) allows you to reduce typing by not having to use underscores in modern keywords.
