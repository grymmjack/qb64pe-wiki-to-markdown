...
<head>
<title>_glStencilFunc - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlStencilFunc rootpage-GlStencilFunc skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glStencilFunc</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glStencilFunc</b> statement sets the statement and reference value for stencil testing.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glStencilFunc</a> GLenum <i>func</i>, GLint <i>ref</i>, GLuint <i>mask</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glstencilfunc" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlAlphaFunc" title="GlAlphaFunc">_glAlphaFunc</a>, <a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlBlendFunc" title="GlBlendFunc">_glBlendFunc</a>, <a href="GlDepthFunc" title="GlDepthFunc">_glDepthFunc</a></li>
<li><a href="GlEnable" title="GlEnable">_glEnable</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlIsEnabled" title="GlIsEnabled">_glIsEnabled</a>, <a href="GlLogicOp" title="GlLogicOp">_glLogicOp</a></li>
<li><a href="GlStencilOp" title="GlStencilOp">_glStencilOp</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210846
Cache expiry: 86400
...
100.00%   28.839      1 -total
 28.83%    8.314      1 Template:OpenGLTypesPlugin
 19.04%    5.490      1 Template:PageSeeAlso
 11.02%    3.179      3 Template:Parameter
 10.31%    2.974      1 Template:PageSyntax
  9.95%    2.870      1 Template:PageDescription
  9.54%    2.750      1 Template:FixedEnd
  8.53%    2.461      1 Template:PageNavigation
  8.51%    2.454      1 Template:PageParameters
  8.16%    2.353      1 Template:FixedStart
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:730-0!canonical and timestamp 20240714210846 and revision id 7031.
 -->
</div>
</div>
</div>
