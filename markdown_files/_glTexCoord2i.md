...
<head>
<title>_glTexCoord2i - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexCoord2i rootpage-GlTexCoord2i skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexCoord2i</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexCoord2i</b> statement sets the current texture coordinates.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexCoord2i</a> GLint <i>s</i>, GLint <i>t</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexcoord2i" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   32.780      1 -total
 25.36%    8.313      1 Template:OpenGLTypesPlugin
 22.92%    7.512      1 Template:PageSyntax
 16.59%    5.439      2 Template:Parameter
  9.94%    3.257      1 Template:PageSeeAlso
  7.61%    2.493      1 Template:PageDescription
  7.39%    2.421      1 Template:PageParameters
  7.24%    2.374      1 Template:FixedEnd
  7.12%    2.333      1 Template:PageNavigation
  7.01%    2.298      1 Template:FixedStart
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1084-0!canonical and timestamp 20240714213529 and revision id 7046.
 -->
</div>
</div>
</div>
