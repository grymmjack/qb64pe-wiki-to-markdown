...
<head>
<title>_glGetPolygonStipple - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlGetPolygonStipple rootpage-GlGetPolygonStipple skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glGetPolygonStipple</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glGetPolygonStipple</b> statement returns the polygon stipple pattern.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glGetPolygonStipple</a> GLubyte <i>*mask</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetpolygonstipple" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
<li><a href="GlPolygonStipple" title="GlPolygonStipple">_glPolygonStipple</a>, <a href="GlReadPixels" title="GlReadPixels">_glReadPixels</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714185837
Cache expiry: 86400
...
100.00%   19.082      1 -total
 33.49%    6.391      1 Template:OpenGLTypesPlugin
 11.86%    2.264      1 Template:PageSyntax
 11.58%    2.210      1 Template:PageNavigation
 10.81%    2.062      1 Template:PageDescription
 10.38%    1.980      1 Template:FixedStart
 10.14%    1.934      1 Template:Parameter
  9.86%    1.881      1 Template:FixedEnd
  9.72%    1.855      1 Template:PageParameters
  9.49%    1.810      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:938-0!canonical and timestamp 20240714185837 and revision id 6893.
 -->
</div>
</div>
</div>
