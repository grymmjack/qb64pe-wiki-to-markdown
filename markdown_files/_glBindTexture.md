...
<head>
<title>_glBindTexture - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlBindTexture rootpage-GlBindTexture skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glBindTexture</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glBindTexture</b> statement enables the creation of a named texture that is bound to a texture target.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glBindTexture</a> GLenum <i>target</i>, GLuint <i>texture</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glbindtexture" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlAreTexturesResident" title="GlAreTexturesResident">_glAreTexturesResident</a>, <a href="GlDeleteTextures" title="GlDeleteTextures">_glDeleteTextures</a>, <a href="GlGenTextures" title="GlGenTextures">_glGenTextures</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv" rel="nofollow">_glGet</a></li>
<li><a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgettexparameter" rel="nofollow">_glGetTexParameter</a>, <a href="GlIsTexture" title="GlIsTexture">_glIsTexture</a>, <a href="GlPrioritizeTextures" title="GlPrioritizeTextures">_glPrioritizeTextures</a>, <a href="GlTexImage1D" title="GlTexImage1D">_glTexImage1D</a></li>
...
Post‐expand include size: 6900/2097152 bytes
...
100.00%   32.619      1 -total
 33.52%   10.934      1 Template:OpenGLTypesPlugin
 20.66%    6.738      1 Template:PageParameters
 11.15%    3.638      2 Template:Parameter
 10.05%    3.277      1 Template:FixedStart
  9.65%    3.147      1 Template:PageSyntax
  9.02%    2.943      1 Template:FixedEnd
  8.25%    2.692      1 Template:PageDescription
  7.33%    2.392      1 Template:PageSeeAlso
  6.51%    2.125      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:684-0!canonical and timestamp 20240714162635 and revision id 6782.
 -->
</div>
</div>
</div>
