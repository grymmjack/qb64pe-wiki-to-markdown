...
<head>
<title>_glClearStencil - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlClearStencil rootpage-GlClearStencil skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glClearStencil</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glClearStencil</b> statement specifies the clear value for the stencil buffer.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glClearStencil</a> GLint <i>s</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glclearstencil" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   25.241      1 -total
 30.32%    7.652      1 Template:OpenGLTypesPlugin
 15.06%    3.802      1 Template:PageDescription
 12.58%    3.175      1 Template:PageNavigation
 10.60%    2.675      1 Template:PageParameters
 10.07%    2.541      1 Template:PageSeeAlso
  9.98%    2.520      1 Template:FixedStart
  9.59%    2.422      1 Template:PageSyntax
  8.98%    2.266      1 Template:FixedEnd
  8.43%    2.127      1 Template:Parameter
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:690-0!canonical and timestamp 20240714204349 and revision id 6792.
 -->
</div>
</div>
</div>
