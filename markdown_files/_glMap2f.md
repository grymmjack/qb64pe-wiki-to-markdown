...
<head>
<title>_glMap2f - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMap2f rootpage-GlMap2f skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMap2f</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMap2f</b> statement defines a two-dimensional evaluator.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMap2f</a> GLenum <i>target</i>, GLfloat <i>u1</i>, GLfloat <i>u2</i>, GLint <i>ustride</i>, GLint <i>uorder</i>, GLfloat <i>v1</i>, GLfloat <i>v2</i>, GLint <i>vstride</i>, GLint <i>vorder</i>, const GLfloat <i>*points</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmap2f" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   28.172      1 -total
 41.01%   11.554      1 Template:OpenGLTypesPlugin
 24.50%    6.902      1 Template:FixedEnd
 11.15%    3.142      1 Template:PageDescription
  9.69%    2.729      1 Template:PageSyntax
  8.92%    2.512     10 Template:Parameter
  8.62%    2.429      1 Template:PageNavigation
  7.93%    2.235      1 Template:PageSeeAlso
  7.89%    2.222      1 Template:PageParameters
  7.64%    2.152      1 Template:FixedStart
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:980-0!canonical and timestamp 20240714173545 and revision id 6942.
 -->
</div>
</div>
</div>
