...
<head>
<title>_glPolygonMode - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlPolygonMode rootpage-GlPolygonMode skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glPolygonMode</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glPolygonMode</b> statement selects a polygon rasterization mode.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glPolygonMode</a> GLenum <i>face</i>, GLenum <i>mode</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glpolygonmode" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gledgeflag-functions" rel="nofollow">_glEdgeFlag</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlLineStipple" title="GlLineStipple">_glLineStipple</a></li>
<li><a href="GlLineWidth" title="GlLineWidth">_glLineWidth</a>, <a href="GlPointSize" title="GlPointSize">_glPointSize</a>, <a href="GlPolygonStipple" title="GlPolygonStipple">_glPolygonStipple</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210802
Cache expiry: 86400
...
100.00%   47.323      1 -total
 32.16%   15.221      1 Template:OpenGLTypesPlugin
 14.67%    6.941      1 Template:PageSyntax
 11.78%    5.574      2 Template:Parameter
 11.57%    5.473      1 Template:PageParameters
 11.51%    5.445      1 Template:PageNavigation
  9.59%    4.539      1 Template:FixedEnd
  8.63%    4.086      1 Template:FixedStart
  8.35%    3.951      1 Template:PageDescription
  7.79%    3.685      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:725-0!canonical and timestamp 20240714210802 and revision id 6977.
 -->
</div>
</div>
</div>
