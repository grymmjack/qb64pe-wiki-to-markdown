...
<head>
<title>_glTexCoord4iv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexCoord4iv rootpage-GlTexCoord4iv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexCoord4iv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexCoord4iv</b> statement sets the current texture coordinates.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexCoord4iv</a> const GLint <i>*v</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexcoord4iv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   36.815      1 -total
 29.58%   10.890      1 Template:PageParameters
 26.91%    9.906      1 Template:OpenGLTypesPlugin
 14.25%    5.247      1 Template:PageNavigation
  9.53%    3.509      1 Template:FixedEnd
  8.96%    3.299      1 Template:FixedStart
  8.72%    3.211      1 Template:PageDescription
  7.27%    2.676      1 Template:PageSeeAlso
  5.55%    2.042      1 Template:Parameter
  5.50%    2.023      1 Template:PageSyntax
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1100-0!canonical and timestamp 20240714213544 and revision id 7063.
 -->
</div>
</div>
</div>
