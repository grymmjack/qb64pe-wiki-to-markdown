...
<head>
<title>_glEvalCoord2f - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlEvalCoord2f rootpage-GlEvalCoord2f skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glEvalCoord2f</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glEvalCoord2f</b> statement evaluates enabled two-dimensional maps.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glEvalCoord2f</a> GLfloat <i>u</i>, GLfloat <i>v</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glevalcoord2f" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   21.811      1 -total
 29.13%    6.353      1 Template:OpenGLTypesPlugin
 13.16%    2.870      1 Template:PageSyntax
 12.50%    2.726      1 Template:PageNavigation
 12.13%    2.645      1 Template:PageDescription
 11.33%    2.472      1 Template:PageSeeAlso
  9.69%    2.113      2 Template:Parameter
  8.84%    1.927      1 Template:FixedStart
  8.35%    1.821      1 Template:FixedEnd
  8.21%    1.790      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:909-0!canonical and timestamp 20240714213249 and revision id 6859.
 -->
</div>
</div>
</div>
