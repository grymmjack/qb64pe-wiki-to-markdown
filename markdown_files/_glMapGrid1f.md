...
<head>
<title>_glMapGrid1f - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMapGrid1f rootpage-GlMapGrid1f skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMapGrid1f</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMapGrid1f</b> statement defines a one-dimensional mesh.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMapGrid1f</a> GLint <i>un</i>, GLfloat <i>u1</i>, GLfloat <i>u2</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmapgrid1f" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   93.583      1 -total
 42.46%   39.738      1 Template:OpenGLTypesPlugin
 15.57%   14.575      1 Template:PageParameters
 13.46%   12.597      3 Template:Parameter
 13.26%   12.406      1 Template:FixedStart
 10.57%    9.893      1 Template:PageDescription
 10.41%    9.743      1 Template:FixedEnd
  7.61%    7.123      1 Template:PageSyntax
  5.12%    4.793      1 Template:PageSeeAlso
  3.94%    3.691      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:986-0!canonical and timestamp 20240714213355 and revision id 6944.
 -->
</div>
</div>
</div>
