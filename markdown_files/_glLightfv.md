...
<head>
<title>_glLightfv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlLightfv rootpage-GlLightfv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glLightfv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glLightfv</b> statement returns light source parameter values.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glLightfv</a> GLenum <i>light</i>, GLenum <i>pname</i>, const GLfloat <i>*params</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gllightfv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   40.877      1 -total
 22.22%    9.083      1 Template:OpenGLTypesPlugin
 20.17%    8.245      3 Template:Parameter
 19.13%    7.821      1 Template:PageDescription
 14.95%    6.113      1 Template:PageSyntax
  8.25%    3.374      1 Template:FixedStart
  7.49%    3.061      1 Template:PageSeeAlso
  7.10%    2.902      1 Template:FixedEnd
  6.90%    2.821      1 Template:PageParameters
  6.58%    2.690      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:972-0!canonical and timestamp 20240714213341 and revision id 6928.
 -->
</div>
</div>
</div>
