...
<head>
<title>_glDeleteTextures - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlDeleteTextures rootpage-GlDeleteTextures skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glDeleteTextures</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glDeleteTextures</b> statement deletes named textures.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glDeleteTextures</a> GLsizei <i>n</i>, const GLuint <i>*textures</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gldeletetextures" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlAreTexturesResident" title="GlAreTexturesResident">_glAreTexturesResident</a>, <a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlBindTexture" title="GlBindTexture">_glBindTexture</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li>
<li><a href="GlGenTextures" title="GlGenTextures">_glGenTextures</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv" rel="nofollow">_glGet</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgettexparameter" rel="nofollow">_glGetTexParameter</a>, <a href="GlIsTexture" title="GlIsTexture">_glIsTexture</a></li>
<li><a href="GlPrioritizeTextures" title="GlPrioritizeTextures">_glPrioritizeTextures</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexgen-functions" rel="nofollow">_glTexGen</a>, <a href="GlTexImage1D" title="GlTexImage1D">_glTexImage1D</a>, <a href="GlTexImage2D" title="GlTexImage2D">_glTexImage2D</a></li>
...
100.00%   54.854      1 -total
 23.54%   12.915      1 Template:OpenGLTypesPlugin
 21.23%   11.648      1 Template:PageParameters
 16.43%    9.012      1 Template:PageSyntax
 11.81%    6.477      2 Template:Parameter
 11.00%    6.032      1 Template:PageSeeAlso
  7.50%    4.113      1 Template:PageDescription
  6.52%    3.579      1 Template:PageNavigation
  5.84%    3.204      1 Template:FixedEnd
  5.61%    3.077      1 Template:FixedStart
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:706-0!canonical and timestamp 20240714193344 and revision id 6836.
 -->
</div>
</div>
</div>
