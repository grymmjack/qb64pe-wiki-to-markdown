...
<head>
<title>_glPixelTransferf - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlPixelTransferf rootpage-GlPixelTransferf skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glPixelTransferf</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glPixelTransferf</b> statement sets pixel transfer modes.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glPixelTransferf</a> GLenum <i>pname</i>, GLfloat <i>param</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glpixeltransferf" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   15.242      1 -total
 34.66%    5.283      1 Template:OpenGLTypesPlugin
 12.34%    1.880      1 Template:PageSyntax
 11.05%    1.684      1 Template:FixedStart
 10.63%    1.620      1 Template:FixedEnd
 10.48%    1.598      2 Template:Parameter
  9.92%    1.512      1 Template:PageNavigation
  9.77%    1.489      1 Template:PageDescription
  9.52%    1.451      1 Template:PageSeeAlso
  9.51%    1.449      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1014-0!canonical and timestamp 20240714145220 and revision id 6973.
 -->
</div>
</div>
</div>
