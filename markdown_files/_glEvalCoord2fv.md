...
<head>
<title>_glEvalCoord2fv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlEvalCoord2fv rootpage-GlEvalCoord2fv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glEvalCoord2fv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glEvalCoord2fv</b> statement evaluates enabled two-dimensional maps.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glEvalCoord2fv</a> const GLfloat <i>*u</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glevalcoord2fv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   41.980      1 -total
 26.41%   11.088      1 Template:PageSyntax
 18.19%    7.636      1 Template:OpenGLTypesPlugin
 17.35%    7.283      1 Template:PageNavigation
 11.90%    4.995      1 Template:PageSeeAlso
 11.85%    4.973      1 Template:Parameter
  6.85%    2.875      1 Template:PageDescription
  6.53%    2.741      1 Template:FixedStart
  5.43%    2.281      1 Template:PageParameters
  5.02%    2.108      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:908-0!canonical and timestamp 20240714213250 and revision id 6860.
 -->
</div>
</div>
</div>
