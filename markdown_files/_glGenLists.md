...
<head>
<title>_glGenLists - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlGenLists rootpage-GlGenLists skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glGenLists</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glGenLists</b> function generates a contiguous set of empty display lists.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd>GLuint <i>result</i> = <a class="mw-selflink selflink">_glGenLists</a> (GLsizei <i>range</i>)</dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glgenlists" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
<li><a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlIsList" title="GlIsList">_glIsList</a>, <a href="GlNewList" title="GlNewList">_glNewList</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714212218
Cache expiry: 86400
...
100.00%   17.582      1 -total
 29.69%    5.220      1 Template:OpenGLTypesPlugin
 15.94%    2.803      1 Template:PageSyntax
 12.48%    2.194      2 Template:Parameter
 10.32%    1.815      1 Template:PageParameters
  9.66%    1.698      1 Template:PageSeeAlso
  9.11%    1.601      1 Template:FixedEnd
  8.88%    1.561      1 Template:PageNavigation
  8.76%    1.540      1 Template:PageDescription
  8.73%    1.535      1 Template:FixedStart
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:920-0!canonical and timestamp 20240714212218 and revision id 6874.
 -->
</div>
</div>
</div>
