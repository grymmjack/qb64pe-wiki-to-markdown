...
<head>
<title>_glTranslated - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTranslated rootpage-GlTranslated skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTranslated</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTranslated</b> statement multiplies the current matrix by a translation matrix.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTranslated</a> GLdouble <i>x</i>, GLdouble <i>y</i>, GLdouble <i>z</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltranslated" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
<li><a href="GlPushMatrix" title="GlPushMatrix">_glPushMatrix</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glrotate" rel="nofollow">_glRotate</a>, <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glscale" rel="nofollow">_glScale</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714185453
Cache expiry: 86400
...
100.00%   16.981      1 -total
 31.89%    5.416      1 Template:OpenGLTypesPlugin
 12.48%    2.120      1 Template:PageSyntax
 11.57%    1.965      1 Template:PageNavigation
 10.69%    1.816      3 Template:Parameter
  9.93%    1.687      1 Template:PageSeeAlso
  9.92%    1.685      1 Template:FixedStart
  9.88%    1.678      1 Template:PageDescription
  9.69%    1.646      1 Template:FixedEnd
  9.67%    1.642      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1119-0!canonical and timestamp 20240714185453 and revision id 7085.
 -->
</div>
</div>
</div>
