...
<head>
<title>_glPointSize - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlPointSize rootpage-GlPointSize skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glPointSize</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glPointSize</b> statement specifies the diameter of rasterized points.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glPointSize</a> GLfloat <i>size</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glpointsize" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnable" title="GlEnable">_glEnable</a>, <a href="GlEnd" title="GlEnd">_glEnd</a>, <a href="GlIsEnabled" title="GlIsEnabled">_glIsEnabled</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714210801
Cache expiry: 86400
...
100.00%   51.346      1 -total
 46.38%   23.814      1 Template:OpenGLTypesPlugin
 17.02%    8.741      1 Template:FixedEnd
 11.26%    5.780      1 Template:PageSeeAlso
 10.63%    5.460      1 Template:FixedStart
 10.01%    5.140      1 Template:PageSyntax
  9.56%    4.908      1 Template:Parameter
  8.59%    4.409      1 Template:PageNavigation
  7.04%    3.615      1 Template:PageDescription
  5.31%    2.729      1 Template:PageParameters
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:724-0!canonical and timestamp 20240714210801 and revision id 6976.
 -->
</div>
</div>
</div>
