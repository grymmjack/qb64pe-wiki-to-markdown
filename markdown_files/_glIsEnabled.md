...
<head>
<title>_glIsEnabled - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlIsEnabled rootpage-GlIsEnabled skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glIsEnabled</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glIsEnabled</b> function tests whether a capability is enabled.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd>GLboolean <i>result</i> = <a class="mw-selflink selflink">_glIsEnabled</a> (GLenum <i>cap</i>)</dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glisenabled" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul><li><a href="GL" title="GL">SUB _GL</a></li>
<li><a href="GlBegin" title="GlBegin">_glBegin</a>, <a href="GlEnable" title="GlEnable">_glEnable</a>, <a href="GlEnd" title="GlEnd">_glEnd</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240715033039
Cache expiry: 86400
...
100.00%   15.773      1 -total
 33.73%    5.320      1 Template:OpenGLTypesPlugin
 12.90%    2.035      1 Template:PageSyntax
 11.33%    1.787      1 Template:PageParameters
 11.11%    1.752      1 Template:FixedStart
 10.28%    1.622      2 Template:Parameter
 10.09%    1.592      1 Template:PageDescription
  9.36%    1.477      1 Template:FixedEnd
  9.16%    1.444      1 Template:PageNavigation
  8.88%    1.401      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:720-0!canonical and timestamp 20240715033039 and revision id 6920.
 -->
</div>
</div>
</div>
