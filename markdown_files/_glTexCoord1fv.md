...
<head>
<title>_glTexCoord1fv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlTexCoord1fv rootpage-GlTexCoord1fv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glTexCoord1fv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glTexCoord1fv</b> statement sets the current texture coordinates.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glTexCoord1fv</a> const GLfloat <i>*v</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/gltexcoord1fv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   23.442      1 -total
 33.43%    7.837      1 Template:OpenGLTypesPlugin
 11.89%    2.788      1 Template:PageSyntax
 11.23%    2.633      1 Template:PageParameters
 10.53%    2.468      1 Template:Parameter
 10.12%    2.373      1 Template:PageDescription
 10.11%    2.370      1 Template:FixedStart
  9.93%    2.328      1 Template:FixedEnd
  9.56%    2.242      1 Template:PageNavigation
  9.49%    2.224      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1074-0!canonical and timestamp 20240714213520 and revision id 7037.
 -->
</div>
</div>
</div>
