...
<head>
<title>_glRasterPos4iv - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlRasterPos4iv rootpage-GlRasterPos4iv skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glRasterPos4iv</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glRasterPos4iv</b> statement specifies the raster position for pixel operations.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glRasterPos4iv</a> const GLint <i>*v</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glrasterpos4iv" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   21.624      1 -total
 35.09%    7.587      1 Template:OpenGLTypesPlugin
 13.69%    2.961      1 Template:PageSyntax
 10.38%    2.245      1 Template:FixedStart
 10.35%    2.238      1 Template:Parameter
  9.99%    2.160      1 Template:PageDescription
  9.72%    2.102      1 Template:FixedEnd
  9.65%    2.087      1 Template:PageParameters
  9.45%    2.044      1 Template:PageNavigation
  8.24%    1.783      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:1053-0!canonical and timestamp 20240714212400 and revision id 7010.
 -->
</div>
</div>
</div>
