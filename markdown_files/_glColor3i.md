...
<head>
<title>_glColor3i - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlColor3i rootpage-GlColor3i skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glColor3i</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glColor3i</b> statement sets the current color.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glColor3i</a> GLint <i>red</i>, GLint <i>green</i>, GLint <i>blue</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glcolor3i" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   29.583      1 -total
 38.56%   11.406      1 Template:OpenGLTypesPlugin
 16.94%    5.012      1 Template:PageParameters
  9.63%    2.848      1 Template:FixedStart
  9.33%    2.760      1 Template:PageSyntax
  9.17%    2.713      1 Template:FixedEnd
  8.46%    2.502      1 Template:PageDescription
  8.21%    2.430      1 Template:PageNavigation
  8.11%    2.398      1 Template:PageSeeAlso
  7.01%    2.073      3 Template:Parameter
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:873-0!canonical and timestamp 20240715020552 and revision id 6800.
 -->
</div>
</div>
</div>
