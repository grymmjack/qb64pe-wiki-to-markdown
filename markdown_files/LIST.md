...
KEY LIST - QB64 Phoenix Edition Wiki
...
(Redirected from [LIST](/qb64wiki/index.php?title=LIST&redirect=no "LIST"))
...
| ``` [KEY](/qb64wiki/index.php/KEY_n "KEY n") 1, "Help" KEY LIST INPUT "Press F1 or to quit press ENTER: ", a$   ``` |
| --- |
...
* KEY LIST, [ON KEY(n)](/qb64wiki/index.php/ON_KEY(n) "ON KEY(n)")
...
Retrieved from "<https://qb64phoenix.com/qb64wiki/index.php?title=KEY_LIST&oldid=8041>"
