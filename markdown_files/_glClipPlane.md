...
<head>
<title>_glClipPlane - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlClipPlane rootpage-GlClipPlane skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glClipPlane</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glClipPlane</b> statement specifies a plane against which all geometry is clipped.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glClipPlane</a> GLenum <i>plane</i>, const GLdouble <i>*equation</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glclipplane" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
<li><a href="GlGetClipPlane" title="GlGetClipPlane">_glGetClipPlane</a>, <a href="GlIsEnabled" title="GlIsEnabled">_glIsEnabled</a></li></ul>
<p>
</p>
<!-- 
NewPP limit report
Cached time: 20240714204350
Cache expiry: 86400
...
100.00%   29.719      1 -total
 32.16%    9.559      1 Template:OpenGLTypesPlugin
 13.80%    4.100      1 Template:PageParameters
 11.52%    3.425      1 Template:PageSyntax
 11.43%    3.396      1 Template:PageDescription
 10.80%    3.210      1 Template:FixedStart
 10.07%    2.992      1 Template:FixedEnd
  9.01%    2.677      2 Template:Parameter
  8.40%    2.497      1 Template:PageSeeAlso
  8.13%    2.415      1 Template:PageNavigation
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:856-0!canonical and timestamp 20240714204350 and revision id 6793.
 -->
</div>
</div>
</div>
