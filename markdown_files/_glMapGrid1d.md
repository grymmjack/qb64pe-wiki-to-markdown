...
<head>
<title>_glMapGrid1d - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlMapGrid1d rootpage-GlMapGrid1d skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glMapGrid1d</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glMapGrid1d</b> statement defines a one-dimensional mesh.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glMapGrid1d</a> GLint <i>un</i>, GLdouble <i>u1</i>, GLdouble <i>u2</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glmapgrid1d" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   17.545      1 -total
 32.34%    5.674      1 Template:OpenGLTypesPlugin
 13.37%    2.345      1 Template:PageSyntax
 10.99%    1.929      3 Template:Parameter
  9.99%    1.753      1 Template:PageParameters
  9.90%    1.737      1 Template:PageDescription
  9.87%    1.731      1 Template:FixedStart
  9.51%    1.669      1 Template:PageSeeAlso
  9.43%    1.655      1 Template:PageNavigation
  9.42%    1.652      1 Template:FixedEnd
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:987-0!canonical and timestamp 20240715055125 and revision id 6943.
 -->
</div>
</div>
</div>
