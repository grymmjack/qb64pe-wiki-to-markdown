...
<head>
<title>_glEvalCoord1f - QB64 Phoenix Edition Wiki</title>
</head>
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-GlEvalCoord1f rootpage-GlEvalCoord1f skin-vector action-view skin-vector-legacy vector-feature-language-in-header-enabled vector-feature-language-in-main-page-header-disabled vector-feature-language-alert-in-sidebar-disabled vector-feature-sticky-header-disabled vector-feature-sticky-header-edit-disabled vector-feature-table-of-contents-disabled vector-feature-visual-enhancement-next-disabled">
<div class="mw-body" id="content" role="main">
<a id="top"></a>
<h1 class="firstHeading mw-first-heading" id="firstHeading">_glEvalCoord1f</h1>
<div class="vector-body" id="bodyContent">
<div class="mw-body-content mw-content-ltr" dir="ltr" id="mw-content-text" lang="en"><div class="mw-parser-output"><p>The <b>_glEvalCoord1f</b> statement evaluates enabled one-dimensional maps.
</p>
<h2><span class="mw-headline" id="Syntax">Syntax</span></h2>
<dl><dd><a class="mw-selflink selflink">_glEvalCoord1f</a> GLfloat <i>u</i></dd></dl>
<p>
</p>
...
<li>The full description for this command can be found at <a class="external text" href="https://learn.microsoft.com/en-us/windows/win32/opengl/glevalcoord1f" rel="nofollow">Microsoft Docs</a> and is also valid for QB64 usage.</li></ul>
<p>
</p>
...
100.00%   29.447      1 -total
 34.56%   10.176      1 Template:Parameter
 20.08%    5.913      1 Template:OpenGLTypesPlugin
 17.89%    5.269      1 Template:PageSyntax
  7.17%    2.111      1 Template:PageParameters
  7.08%    2.086      1 Template:PageDescription
  6.58%    1.936      1 Template:FixedStart
  6.03%    1.775      1 Template:FixedEnd
  5.62%    1.654      1 Template:PageNavigation
  5.34%    1.572      1 Template:PageSeeAlso
-->
<!-- Saved in parser cache with key qb64pnix_mw19894-mwmb_:pcache:idhash:906-0!canonical and timestamp 20240714213246 and revision id 6855.
 -->
</div>
</div>
</div>
