...
* When passing numericExpression as a [DOUBLE](DOUBLE.md) or _FLOAT variable, then it must be less than or equal to 709.782712893 or an "overflow" error will occur. You may pass literal numbers as [DOUBLE](DOUBLE.md) or _FLOAT values by explicitly adding the # or ## type suffix to it respectively, e.g. result = [EXP](EXP.md) (678.9##) .
